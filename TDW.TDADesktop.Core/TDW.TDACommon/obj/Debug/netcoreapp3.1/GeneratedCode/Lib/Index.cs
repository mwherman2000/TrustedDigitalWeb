...
namespace TDW.TDACommon
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="TDW.TDACommon.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through TDW.TDACommon.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
