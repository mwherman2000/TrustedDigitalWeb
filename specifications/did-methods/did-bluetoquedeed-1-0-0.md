...
The "BlueToqueTools Deed" Decentralized Identifier Method Namespace Specification 
("BlueToqueTools Deed" DID Method Namespace Specification) 
...
- houses
- cattle ranches
- livestock (e.g. cows, calves, horses)
- livestock feed (e.g. hay, grain, supplements)
- vehicles (e.g. cars, trucks, snowmobiles, trailers)
...
that are compliant with the "BlueToqueTools Deed" DID Method Namespace Specification.
...
- The term "BlueToqueTools Deed" DID Method Namespace Specification is synonymous with the terms "BlueToqueTools Deed" Decentralized Identifier Method Namespace Specification and Trusted Digital Web "BlueToqueTools Deed" DID Method Namespace Specification.
- A compliant Trusted Digital Web Runtime Library is a software library that, in part, implements the "BlueToqueTools Deed" DID Document CRUD Abstract Interface in a way that complies with the "BlueToqueTools Deed" DID Method Namespace Specification.
...
The authoriative source text for this specifcation can be found here: https://github.com/mwherman2000/TrustedDigitalWeb/blob/master/specifications/did-methods/did-bluetoquedeed-1-0-0.md.
...
```json
{
    "id": "did:bluetoquedeed:BF5pxRJP6THrUtlDdhh07hJEDKrJxkcR9m5u1xs33bhp",
    "verificationMethod": [{
        "id": "did:bluetoquedeed:BF5pxRJP6THrUtlDdhh07hJEDKrJxkcR9m5u1xs33bhp#keys-1",
        "type": [ "Ed25519VerificationKey2020" ],
        "publicKeyMultibase": "zAKJP3f7BD6W4iWEQ9jwndVTCBq8ua2Utt8EEjJ6Vxsf"
    }, {
        "id": "did:bluetoquedeed:BF5pxRJP6THrUtlDdhh07hJEDKrJxkcR9m5u1xs33bhp#keys-2",
        "type": ["Ed25519VerificationKey2020"],
        "publicKeyMultibase": "z4BWwfeqdp1obQptLLMvPNgBw48p7og1ie6Hf9p5nTpNN"
    }],
    "authentication": [{
        "type": "Secp256r1SignatureAuthentication2018",
        "verificationMethod": "did:bluetoquedeed:BF5pxRJP6THrUtlDdhh07hJEDKrJxkcR9m5u1xs33bhp#keys-1"
    }, {
        "type": "Secp256r1SignatureAuthentication2018",
        "verificationMethod": "did:bluetoquedeed:BF5pxRJP6THrUtlDdhh07hJEDKrJxkcR9m5u1xs33bhp#keys-2"
    }],
    "service": [{
        "id":"#agent1",
...
that, in turn, leverage the "BlueToqueTools Deed" Method Namespace Specification; as one example, whether the underlying VDR is configured to support concensus by PoA, PoS, or PoW 
...
used to develop agents, services, and libraries for the Trusted Digital Web that, that in turn, leverage the "BlueToqueTools Deed" Method Namespace Specification. 
...
[62] What is a Non-Fungible Token (NFT)?, https://twitter.com/mwherman2000/status/1465662128262729732.
