...
namespace TDW.VDAServer
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="TDW.VDAServer.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through TDW.VDAServer.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
