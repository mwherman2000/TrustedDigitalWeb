...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWVDAAccountEntryClaims defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWVDAAccountEntryClaims
    {
        
        ///<summary>
        ///Initializes a new instance of TDWVDAAccountEntryClaims with the specified parameters.
        ///</summary>
        public TDWVDAAccountEntryClaims(string walletname = default(string),string walletpassword = default(string),string walletaccountname = default(string),string ledgeraddress = default(string))
        {
        ...
        public static bool operator ==(TDWVDAAccountEntryClaims a, TDWVDAAccountEntryClaims b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a TDWVDAAccountEntryClaims to its
        ...
        /// in input, if the conversion succeeded, or default(TDWVDAAccountEntryClaims) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWVDAAccountEntryClaims value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDAAccountEntryClaims>(input);
                return true;
            }
            catch { value = default(TDWVDAAccountEntryClaims); return false; }
        }
        public static TDWVDAAccountEntryClaims Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDAAccountEntryClaims>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWVDAAccountEntryClaims defined in TSL.
    /// </summary>
    public unsafe partial class TDWVDAAccountEntryClaims_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWVDAAccountEntryClaims_Accessor(byte* _CellPtr
        ...
        public unsafe StringAccessor walletname
        {
            get
            {
                ...
                byte* targetPtr = m_ptr;
                {}walletname_Accessor_Field.m_ptr = targetPtr + 4;
        ...
        public unsafe StringAccessor walletaccountname
        {
            get
            {
                ...
                byte* targetPtr = m_ptr;
                {targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}walletaccountname_Accessor_Field.m_ptr = targetPtr + 4;
        ...
        public unsafe StringAccessor ledgeraddress
        {
            get
            {
                ...
                byte* targetPtr = m_ptr;
                {targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}ledgeraddress_Accessor_Field.m_ptr = targetPtr + 4;
        ...
        public static unsafe implicit operator TDWVDAAccountEntryClaims(TDWVDAAccountEntryClaims_Accessor accessor)
        {
            
            return new TDWVDAAccountEntryClaims(
        ...
        public unsafe static implicit operator TDWVDAAccountEntryClaims_Accessor(TDWVDAAccountEntryClaims field)
        {
            byte* targetPtr = null;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TDWVDAAccountEntryClaims_Accessor ret;
            
            ret = new TDWVDAAccountEntryClaims_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWVDAAccountEntryClaims_Accessor a, TDWVDAAccountEntryClaims_Accessor b)
        {
