...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWPostVDAIdentityRegistryEntryRequest defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWPostVDAIdentityRegistryEntryRequest
    {
        ...
        public static bool operator ==(TDWPostVDAIdentityRegistryEntryRequest a, TDWPostVDAIdentityRegistryEntryRequest b)
        {
        ...
        /// in input, if the conversion succeeded, or default(TDWPostVDAIdentityRegistryEntryRequest) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWPostVDAIdentityRegistryEntryRequest value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDAIdentityRegistryEntryRequest>(input);
                return true;
            }
            catch { value = default(TDWPostVDAIdentityRegistryEntryRequest); return false; }
        }
        public static TDWPostVDAIdentityRegistryEntryRequest Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDAIdentityRegistryEntryRequest>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWPostVDAIdentityRegistryEntryRequest defined in TSL.
    /// </summary>
    public unsafe partial class TDWPostVDAIdentityRegistryEntryRequest_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWPostVDAIdentityRegistryEntryRequest_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}
        ...
        public unsafe TDWVDAIdentityRegistryEntry_Accessor entry
        {
            get
            {
                ...
                byte* targetPtr = m_ptr;
                {{targetPtr += *(int*)targetPtr + sizeof(int);            targetPtr += 8;
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}entry_Accessor_Field.m_ptr = targetPtr;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}
        ...
        public static unsafe implicit operator TDWPostVDAIdentityRegistryEntryRequest(TDWPostVDAIdentityRegistryEntryRequest_Accessor accessor)
        {
            
            return new TDWPostVDAIdentityRegistryEntryRequest(
        ...
        public unsafe static implicit operator TDWPostVDAIdentityRegistryEntryRequest_Accessor(TDWPostVDAIdentityRegistryEntryRequest field)
        {
            byte* targetPtr = null;
        ...
        if(field.entry.credpublickey!= null)
        {
            int strlen_3 = field.entry.credpublickey.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.entry.issuerudid!= null)
        {
            int strlen_3 = field.entry.issuerudid.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.entry.credpublickey!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.entry.credpublickey)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.entry.issuerudid!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.entry.issuerudid)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TDWPostVDAIdentityRegistryEntryRequest_Accessor ret;
            
            ret = new TDWPostVDAIdentityRegistryEntryRequest_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWPostVDAIdentityRegistryEntryRequest_Accessor a, TDWPostVDAIdentityRegistryEntryRequest_Accessor b)
        {
