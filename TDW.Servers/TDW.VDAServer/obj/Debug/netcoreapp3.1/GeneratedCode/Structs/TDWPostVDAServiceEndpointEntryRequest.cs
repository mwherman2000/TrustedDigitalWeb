...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWPostVDAServiceEndpointEntryRequest defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWPostVDAServiceEndpointEntryRequest
    {
        ...
        public static bool operator ==(TDWPostVDAServiceEndpointEntryRequest a, TDWPostVDAServiceEndpointEntryRequest b)
        {
        ...
        /// in input, if the conversion succeeded, or default(TDWPostVDAServiceEndpointEntryRequest) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWPostVDAServiceEndpointEntryRequest value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDAServiceEndpointEntryRequest>(input);
                return true;
            }
            catch { value = default(TDWPostVDAServiceEndpointEntryRequest); return false; }
        }
        public static TDWPostVDAServiceEndpointEntryRequest Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDAServiceEndpointEntryRequest>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWPostVDAServiceEndpointEntryRequest defined in TSL.
    /// </summary>
    public unsafe partial class TDWPostVDAServiceEndpointEntryRequest_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWPostVDAServiceEndpointEntryRequest_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}{            targetPtr += 9;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}
        ...
        public static unsafe implicit operator TDWPostVDAServiceEndpointEntryRequest(TDWPostVDAServiceEndpointEntryRequest_Accessor accessor)
        {
            
            return new TDWPostVDAServiceEndpointEntryRequest(
        ...
        public unsafe static implicit operator TDWPostVDAServiceEndpointEntryRequest_Accessor(TDWPostVDAServiceEndpointEntryRequest field)
        {
            byte* targetPtr = null;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TDWPostVDAServiceEndpointEntryRequest_Accessor ret;
            
            ret = new TDWPostVDAServiceEndpointEntryRequest_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWPostVDAServiceEndpointEntryRequest_Accessor a, TDWPostVDAServiceEndpointEntryRequest_Accessor b)
        {
