...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWVDASmartContractEntryContent defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWVDASmartContractEntryContent
    {
        
        ///<summary>
        ///Initializes a new instance of TDWVDASmartContractEntryContent with the specified parameters.
        ///</summary>
        public TDWVDASmartContractEntryContent(string udid = default(string),List<string> context = default(List<string>),TDWVDASmartContractEntryClaims? claims = default(TDWVDASmartContractEntryClaims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(TDWVDASmartContractEntryContent a, TDWVDASmartContractEntryContent b)
        {
        ...
        public TDWVDASmartContractEntryClaims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a TDWVDASmartContractEntryContent to its
        ...
        /// in input, if the conversion succeeded, or default(TDWVDASmartContractEntryContent) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWVDASmartContractEntryContent value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDASmartContractEntryContent>(input);
                return true;
            }
            catch { value = default(TDWVDASmartContractEntryContent); return false; }
        }
        public static TDWVDASmartContractEntryContent Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDASmartContractEntryContent>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWVDASmartContractEntryContent defined in TSL.
    /// </summary>
    public unsafe partial class TDWVDASmartContractEntryContent_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWVDASmartContractEntryContent_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new TDWVDASmartContractEntryClaims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        TDWVDASmartContractEntryClaims_Accessor claims_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe TDWVDASmartContractEntryClaims_Accessor claims
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator TDWVDASmartContractEntryContent(TDWVDASmartContractEntryContent_Accessor accessor)
        {
            TDWVDASmartContractEntryClaims? _claims = default(TDWVDASmartContractEntryClaims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (TDWVDASmartContractEntryClaims)accessor.claims;
            ...
            return new TDWVDASmartContractEntryContent(
        ...
        public unsafe static implicit operator TDWVDASmartContractEntryContent_Accessor(TDWVDASmartContractEntryContent field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.context!= null)
    {
        ...
        if(field.claims.Value.smartcontractledgeraddress!= null)
        {
            int strlen_3 = field.claims.Value.smartcontractledgeraddress.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.vdaserviceendpointudid!= null)
        {
            int strlen_3 = field.claims.Value.vdaserviceendpointudid.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.smartcontractledgeraddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.smartcontractledgeraddress)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.vdaserviceendpointudid!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.vdaserviceendpointudid)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TDWVDASmartContractEntryContent_Accessor ret;
            
            ret = new TDWVDASmartContractEntryContent_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWVDASmartContractEntryContent_Accessor a, TDWVDASmartContractEntryContent_Accessor b)
        {
