...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWPostVDARevocationListEntryRequest defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWPostVDARevocationListEntryRequest
    {
        ...
        public static bool operator ==(TDWPostVDARevocationListEntryRequest a, TDWPostVDARevocationListEntryRequest b)
        {
        ...
        /// in input, if the conversion succeeded, or default(TDWPostVDARevocationListEntryRequest) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWPostVDARevocationListEntryRequest value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDARevocationListEntryRequest>(input);
                return true;
            }
            catch { value = default(TDWPostVDARevocationListEntryRequest); return false; }
        }
        public static TDWPostVDARevocationListEntryRequest Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWPostVDARevocationListEntryRequest>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWPostVDARevocationListEntryRequest defined in TSL.
    /// </summary>
    public unsafe partial class TDWPostVDARevocationListEntryRequest_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWPostVDARevocationListEntryRequest_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}
        ...
        public static unsafe implicit operator TDWPostVDARevocationListEntryRequest(TDWPostVDARevocationListEntryRequest_Accessor accessor)
        {
            
            return new TDWPostVDARevocationListEntryRequest(
        ...
        public unsafe static implicit operator TDWPostVDARevocationListEntryRequest_Accessor(TDWPostVDARevocationListEntryRequest field)
        {
            byte* targetPtr = null;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TDWPostVDARevocationListEntryRequest_Accessor ret;
            
            ret = new TDWPostVDARevocationListEntryRequest_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWPostVDARevocationListEntryRequest_Accessor a, TDWPostVDARevocationListEntryRequest_Accessor b)
        {
