...
namespace TDW.VDAServer
{
    ...
    public partial struct TDWVDASmartContractEntryEnvelope
    {
        ...
        ///</summary>
        public TDWVDASmartContractEntryEnvelope(TDWVDASmartContractEntryContent? content = default(TDWVDASmartContractEntryContent?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
