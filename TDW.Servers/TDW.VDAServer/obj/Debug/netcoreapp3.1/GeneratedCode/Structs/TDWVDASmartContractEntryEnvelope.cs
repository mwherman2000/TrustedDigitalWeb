...
namespace TDW.VDAServer
{
    ...
    public partial struct TDWVDASmartContractEntryEnvelope
    {
        ...
        ///</summary>
        public TDWVDASmartContractEntryEnvelope(TDWVDASmartContractEntryContent? content = default(TDWVDASmartContractEntryContent?),TRACredential_Label label = default(TRACredential_Label))
        {
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.Value.smartcontractledgeraddress!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.smartcontractledgeraddress.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.vdaserviceendpointudid!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.vdaserviceendpointudid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.Value.smartcontractledgeraddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.smartcontractledgeraddress)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.vdaserviceendpointudid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.vdaserviceendpointudid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
