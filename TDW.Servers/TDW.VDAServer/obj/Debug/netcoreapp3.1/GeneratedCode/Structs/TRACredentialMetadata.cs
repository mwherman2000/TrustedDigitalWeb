...
namespace TDW.VDAServer
{
    ...
    public partial struct TRACredentialMetadata
    {
        ...
        public static bool operator ==(TRACredentialMetadata a, TRACredentialMetadata b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a TRACredentialMetadata to its
        ...
        /// in input, if the conversion succeeded, or default(TRACredentialMetadata) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRACredentialMetadata value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRACredentialMetadata>(input);
                return true;
            }
            catch { value = default(TRACredentialMetadata); return false; }
        }
        public static TRACredentialMetadata Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRACredentialMetadata>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRACredentialMetadata defined in TSL.
    /// </summary>
    public unsafe partial class TRACredentialMetadata_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRACredentialMetadata_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRACredentialMetadata(TRACredentialMetadata_Accessor accessor)
        {
            ...
            return new TRACredentialMetadata(
        ...
        public unsafe static implicit operator TRACredentialMetadata_Accessor(TRACredentialMetadata field)
        {
            byte* targetPtr = null;
...
*(optheader_1 + 0) |= 0x02;
            ...
            }TRACredentialMetadata_Accessor ret;
            
            ret = new TRACredentialMetadata_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRACredentialMetadata_Accessor a, TRACredentialMetadata_Accessor b)
        {
