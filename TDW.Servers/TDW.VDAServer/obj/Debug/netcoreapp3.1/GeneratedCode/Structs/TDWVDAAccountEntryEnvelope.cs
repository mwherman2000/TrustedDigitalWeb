...
namespace TDW.VDAServer
{
    ...
    public partial struct TDWVDAAccountEntryEnvelope
    {
        ...
        ///</summary>
        public TDWVDAAccountEntryEnvelope(TDWVDAAccountEntryContent? content = default(TDWVDAAccountEntryContent?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
