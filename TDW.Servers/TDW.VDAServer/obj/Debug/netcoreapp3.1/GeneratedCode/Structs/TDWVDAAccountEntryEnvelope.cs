...
namespace TDW.VDAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TDWVDAAccountEntryEnvelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TDWVDAAccountEntryEnvelope
    {
        
        ///<summary>
        ///Initializes a new instance of TDWVDAAccountEntryEnvelope with the specified parameters.
        ///</summary>
        public TDWVDAAccountEntryEnvelope(TDWVDAAccountEntryContent? content = default(TDWVDAAccountEntryContent?),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public static bool operator ==(TDWVDAAccountEntryEnvelope a, TDWVDAAccountEntryEnvelope b)
        {
        ...
        public TDWVDAAccountEntryContent? content;
        
        public TRACredential_Label label;
        
        /// <summary>
        /// Converts the string representation of a TDWVDAAccountEntryEnvelope to its
        ...
        /// in input, if the conversion succeeded, or default(TDWVDAAccountEntryEnvelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TDWVDAAccountEntryEnvelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDAAccountEntryEnvelope>(input);
                return true;
            }
            catch { value = default(TDWVDAAccountEntryEnvelope); return false; }
        }
        public static TDWVDAAccountEntryEnvelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TDWVDAAccountEntryEnvelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TDWVDAAccountEntryEnvelope defined in TSL.
    /// </summary>
    public unsafe partial class TDWVDAAccountEntryEnvelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TDWVDAAccountEntryEnvelope_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new TDWVDAAccountEntryContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        TDWVDAAccountEntryContent_Accessor content_Accessor_Field;
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe TDWVDAAccountEntryContent_Accessor content
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator TDWVDAAccountEntryEnvelope(TDWVDAAccountEntryEnvelope_Accessor accessor)
        {
            TDWVDAAccountEntryContent? _content = default(TDWVDAAccountEntryContent?);
            if (accessor.Contains_content)
            {
                
                _content = (TDWVDAAccountEntryContent)accessor.content;
                
            }
            
            return new TDWVDAAccountEntryEnvelope(
        ...
        public unsafe static implicit operator TDWVDAAccountEntryEnvelope_Accessor(TDWVDAAccountEntryEnvelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.Value.walletname!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.walletname.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.walletpassword!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.walletpassword.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.walletaccountname!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.walletaccountname.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.ledgeraddress!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.ledgeraddress.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.Value.walletname!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.walletname)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.walletpassword!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.walletpassword)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.walletaccountname!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.walletaccountname)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.ledgeraddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.ledgeraddress)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
...
*(optheader_2 + 0) |= 0x02;
            ...
            }TDWVDAAccountEntryEnvelope_Accessor ret;
            
            ret = new TDWVDAAccountEntryEnvelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TDWVDAAccountEntryEnvelope_Accessor a, TDWVDAAccountEntryEnvelope_Accessor b)
        {
