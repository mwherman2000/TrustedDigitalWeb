...

{
    ...
    if(envelope.content.claims!= null)
    {
        for(int iterator_4 = 0;iterator_4<envelope.content.claims.Count;++iterator_4)
        {

            {
            targetPtr += 1;

        if(envelope.content.claims[iterator_4].key!= null)
        {
            int strlen_6 = envelope.content.claims[iterator_4].key.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( envelope.content.claims[iterator_4].value!= null)
            {

        if(envelope.content.claims[iterator_4].value!= null)
        {
            int strlen_6 = envelope.content.claims[iterator_4].value.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( envelope.content.claims[iterator_4].attribute!= null)
            {

{
    ...
    if(envelope.content.claims[iterator_4].attribute!= null)
    {
        for(int iterator_6 = 0;iterator_6<envelope.content.claims[iterator_4].attribute.Count;++iterator_6)
        {

            {

        if(envelope.content.claims[iterator_4].attribute[iterator_6].key!= null)
        {
            int strlen_8 = envelope.content.claims[iterator_4].attribute[iterator_6].key.Length * 2;
        ...
        if(envelope.content.claims[iterator_4].attribute[iterator_6].value!= null)
        {
            int strlen_8 = envelope.content.claims[iterator_4].attribute[iterator_6].value.Length * 2;
            targetPtr += strlen_8+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( envelope.content.claims[iterator_4].attributes!= null)
            {

{
    ...
    if(envelope.content.claims[iterator_4].attributes!= null)
    {
        for(int iterator_6 = 0;iterator_6<envelope.content.claims[iterator_4].attributes.Count;++iterator_6)
        {

{

    targetPtr += sizeof(int);
    if(envelope.content.claims[iterator_4].attributes[iterator_6]!= null)
    {
        for(int iterator_7 = 0;iterator_7<envelope.content.claims[iterator_4].attributes[iterator_6].Count;++iterator_7)
        {

            {

        if(envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key!= null)
        {
            int strlen_9 = envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key.Length * 2;
        ...
        if(envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value!= null)
        {
            int strlen_9 = envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value.Length * 2;
            targetPtr += strlen_9+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
    ...
    if(envelope.content.claims!= null)
    {
        ...
        if(envelope.content.claims[iterator_4].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.claims[iterator_4].key)
            {
        ...
        if(envelope.content.claims[iterator_4].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.claims[iterator_4].value)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
    ...
    if(envelope.content.claims[iterator_4].attribute!= null)
    {
        ...
        if(envelope.content.claims[iterator_4].attribute[iterator_6].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_8;
            targetPtr += sizeof(int);
            fixed(char* pstr_8 = envelope.content.claims[iterator_4].attribute[iterator_6].key)
            {
        ...
        if(envelope.content.claims[iterator_4].attribute[iterator_6].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_8;
            targetPtr += sizeof(int);
            fixed(char* pstr_8 = envelope.content.claims[iterator_4].attribute[iterator_6].value)
            {
                Memory.Copy(pstr_8, targetPtr, strlen_8);
                targetPtr += strlen_8;
            }
    ...
    if(envelope.content.claims[iterator_4].attributes[iterator_6]!= null)
    {
        ...
        if(envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_9;
            targetPtr += sizeof(int);
            fixed(char* pstr_9 = envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key)
            {
        ...
        if(envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_9;
            targetPtr += sizeof(int);
            fixed(char* pstr_9 = envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value)
            {
                Memory.Copy(pstr_9, targetPtr, strlen_9);
                targetPtr += strlen_9;
            }
...

{
    ...
    if(field.envelope.content.claims!= null)
    {
        for(int iterator_4 = 0;iterator_4<field.envelope.content.claims.Count;++iterator_4)
        {

            {
            targetPtr += 1;

        if(field.envelope.content.claims[iterator_4].key!= null)
        {
            int strlen_6 = field.envelope.content.claims[iterator_4].key.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.envelope.content.claims[iterator_4].value!= null)
            {

        if(field.envelope.content.claims[iterator_4].value!= null)
        {
            int strlen_6 = field.envelope.content.claims[iterator_4].value.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( field.envelope.content.claims[iterator_4].attribute!= null)
            {

{
    ...
    if(field.envelope.content.claims[iterator_4].attribute!= null)
    {
        for(int iterator_6 = 0;iterator_6<field.envelope.content.claims[iterator_4].attribute.Count;++iterator_6)
        {

            {

        if(field.envelope.content.claims[iterator_4].attribute[iterator_6].key!= null)
        {
            int strlen_8 = field.envelope.content.claims[iterator_4].attribute[iterator_6].key.Length * 2;
            targetPtr += strlen_8+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims[iterator_4].attribute[iterator_6].value!= null)
        {
            int strlen_8 = field.envelope.content.claims[iterator_4].attribute[iterator_6].value.Length * 2;
            targetPtr += strlen_8+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( field.envelope.content.claims[iterator_4].attributes!= null)
            {

{
    ...
    if(field.envelope.content.claims[iterator_4].attributes!= null)
    {
        for(int iterator_6 = 0;iterator_6<field.envelope.content.claims[iterator_4].attributes.Count;++iterator_6)
        {

{

    targetPtr += sizeof(int);
    if(field.envelope.content.claims[iterator_4].attributes[iterator_6]!= null)
    {
        for(int iterator_7 = 0;iterator_7<field.envelope.content.claims[iterator_4].attributes[iterator_6].Count;++iterator_7)
        {

            {

        if(field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key!= null)
        {
            int strlen_9 = field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key.Length * 2;
            targetPtr += strlen_9+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value!= null)
        {
            int strlen_9 = field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value.Length * 2;
            targetPtr += strlen_9+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
byte *storedPtr_4 = targetPtr;
    ...
    if(field.envelope.content.claims!= null)
    {
        ...
        if(field.envelope.content.claims[iterator_4].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.claims[iterator_4].key)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.claims[iterator_4].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.claims[iterator_4].value)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...
byte *storedPtr_6 = targetPtr;
    ...
    if(field.envelope.content.claims[iterator_4].attribute!= null)
    {
        ...
        if(field.envelope.content.claims[iterator_4].attribute[iterator_6].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_8;
            targetPtr += sizeof(int);
            fixed(char* pstr_8 = field.envelope.content.claims[iterator_4].attribute[iterator_6].key)
            {
                Memory.Copy(pstr_8, targetPtr, strlen_8);
                targetPtr += strlen_8;
            }
        ...
        if(field.envelope.content.claims[iterator_4].attribute[iterator_6].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_8;
            targetPtr += sizeof(int);
            fixed(char* pstr_8 = field.envelope.content.claims[iterator_4].attribute[iterator_6].value)
            {
                Memory.Copy(pstr_8, targetPtr, strlen_8);
                targetPtr += strlen_8;
            }
...
byte *storedPtr_7 = targetPtr;
    ...
    if(field.envelope.content.claims[iterator_4].attributes[iterator_6]!= null)
    {
        ...
        if(field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key!= null)
        {
            ...
            *(int*)targetPtr = strlen_9;
            targetPtr += sizeof(int);
            fixed(char* pstr_9 = field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].key)
            {
                Memory.Copy(pstr_9, targetPtr, strlen_9);
                targetPtr += strlen_9;
            }
        ...
        if(field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value!= null)
        {
            ...
            *(int*)targetPtr = strlen_9;
            targetPtr += sizeof(int);
            fixed(char* pstr_9 = field.envelope.content.claims[iterator_4].attributes[iterator_6][iterator_7].value)
            {
                Memory.Copy(pstr_9, targetPtr, strlen_9);
                targetPtr += strlen_9;
            }
