...

{
    ...
    if(envelope.content.context!= null)
    {
        ...
        if(envelope.content.claims.Value.cbc_RegistrationName!= null)
        {
            int strlen_5 = envelope.content.claims.Value.cbc_RegistrationName.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.claims.Value.cbc_CompanyID._schemeID!= null)
        {
            int strlen_6 = envelope.content.claims.Value.cbc_CompanyID._schemeID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
            {

        if(envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
        {
            int strlen_6 = envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.claims.Value.cbc_CompanyID.code!= null)
        {
            int strlen_6 = envelope.content.claims.Value.cbc_CompanyID.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.claims.Value.cbc_RegistrationAddressUdid!= null)
        {
            int strlen_5 = envelope.content.claims.Value.cbc_RegistrationAddressUdid.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(envelope.content.claims.Value.cbc_RegistrationName!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.claims.Value.cbc_RegistrationName)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.claims.Value.cbc_CompanyID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.claims.Value.cbc_CompanyID._schemeID)
            {
        ...
        if(envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...
*(optheader_5 + 0) |= 0x01;
        ...
        if(envelope.content.claims.Value.cbc_CompanyID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.claims.Value.cbc_CompanyID.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(envelope.content.claims.Value.cbc_RegistrationAddressUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.claims.Value.cbc_RegistrationAddressUdid)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...

{
    ...
    if(field.envelope.content.context!= null)
    {
        ...
        if(field.envelope.content.claims.Value.cbc_RegistrationName!= null)
        {
            int strlen_5 = field.envelope.content.claims.Value.cbc_RegistrationName.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims.Value.cbc_CompanyID._schemeID!= null)
        {
            int strlen_6 = field.envelope.content.claims.Value.cbc_CompanyID._schemeID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
            {

        if(field.envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
        {
            int strlen_6 = field.envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims.Value.cbc_CompanyID.code!= null)
        {
            int strlen_6 = field.envelope.content.claims.Value.cbc_CompanyID.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims.Value.cbc_RegistrationAddressUdid!= null)
        {
            int strlen_5 = field.envelope.content.claims.Value.cbc_RegistrationAddressUdid.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(field.envelope.content.claims.Value.cbc_RegistrationName!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.claims.Value.cbc_RegistrationName)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.claims.Value.cbc_CompanyID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.claims.Value.cbc_CompanyID._schemeID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.claims.Value.cbc_CompanyID._schemeAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...
*(optheader_5 + 0) |= 0x01;
        ...
        if(field.envelope.content.claims.Value.cbc_CompanyID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.claims.Value.cbc_CompanyID.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.claims.Value.cbc_RegistrationAddressUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.claims.Value.cbc_RegistrationAddressUdid)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
