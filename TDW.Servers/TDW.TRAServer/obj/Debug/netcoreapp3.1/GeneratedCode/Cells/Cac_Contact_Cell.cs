...

{
    ...
    if(envelope.content.context!= null)
    {
        ...
        if(envelope.content.claims.Value.cbc_Telephone!= null)
        {
            int strlen_5 = envelope.content.claims.Value.cbc_Telephone.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.claims.Value.cbc_Telefax!= null)
        {
            int strlen_5 = envelope.content.claims.Value.cbc_Telefax.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.claims.Value.cbc_ElectronicMail!= null)
        {
            int strlen_5 = envelope.content.claims.Value.cbc_ElectronicMail.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(optheader_3 + 0) |= 0x01;
        ...
        if(envelope.content.claims.Value.cbc_Telephone!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.claims.Value.cbc_Telephone)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.claims.Value.cbc_Telefax!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.claims.Value.cbc_Telefax)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.claims.Value.cbc_ElectronicMail!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.claims.Value.cbc_ElectronicMail)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...

{
    ...
    if(field.envelope.content.context!= null)
    {
        ...
        if(field.envelope.content.claims.Value.cbc_Telephone!= null)
        {
            int strlen_5 = field.envelope.content.claims.Value.cbc_Telephone.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims.Value.cbc_Telefax!= null)
        {
            int strlen_5 = field.envelope.content.claims.Value.cbc_Telefax.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.claims.Value.cbc_ElectronicMail!= null)
        {
            int strlen_5 = field.envelope.content.claims.Value.cbc_ElectronicMail.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(optheader_3 + 0) |= 0x01;
        ...
        if(field.envelope.content.claims.Value.cbc_Telephone!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.claims.Value.cbc_Telephone)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.claims.Value.cbc_Telefax!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.claims.Value.cbc_Telefax)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.claims.Value.cbc_ElectronicMail!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.claims.Value.cbc_ElectronicMail)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
