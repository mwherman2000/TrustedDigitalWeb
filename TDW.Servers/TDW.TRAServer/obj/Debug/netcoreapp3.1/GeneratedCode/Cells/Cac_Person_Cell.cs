...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_Person_Cell defined in TSL.
    /// </summary>
    public partial struct Cac_Person_Cell : ICell
    {
        ///<summary>
        ///The id of the cell.
        ///</summary>
        public long CellId;
        ///<summary>
        ///Initializes a new instance of Cac_Person_Cell with the specified parameters.
        ///</summary>
        public Cac_Person_Cell(long cell_id , Cac_Person_Envelope envelope = default(Cac_Person_Envelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
        ...
        ///Initializes a new instance of Cac_Person_Cell with the specified parameters.
        ///</summary>
        public Cac_Person_Cell( Cac_Person_Envelope envelope = default(Cac_Person_Envelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
        ...
        public Cac_Person_Envelope envelope;
        
        public TRACredential_EnvelopeSeal envelopeseal;
        
        public static bool operator ==(Cac_Person_Cell a, Cac_Person_Cell b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a Cac_Person_Cell to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_Person_Cell) if the conversion
        ...
        /// </returns>
        public static bool TryParse(string input, out Cac_Person_Cell value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Person_Cell>(input);
                return true;
            }
            catch { value = default(Cac_Person_Cell); return false; }
        }
        public static Cac_Person_Cell Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Person_Cell>(input);
        }
        ///<summary>Converts a Cac_Person_Cell to its string representation, in JSON format.</summary>
        ///<returns>A string representation of the Cac_Person_Cell.</returns>
        ...
        public T GetField<T>(string fieldName)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                return TypeConverter<T>.ConvertFrom_Cac_Person_Envelope(this.envelope);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                this.envelope = TypeConverter<T>.ConvertTo_Cac_Person_Envelope(value);
                break;
        ...
        public IEnumerable<KeyValuePair<string, T>> SelectFields<T>(string attributeKey, string attributeValue)
        {
            switch (TypeConverter<T>.type_id)
            {
                ...
                if (StorageSchema.Cac_Person_Cell_descriptor.check_attribute(StorageSchema.Cac_Person_Cell_descriptor.envelope, attributeKey, attributeValue))
                        ...
                        yield return new KeyValuePair<string, T>("envelope", TypeConverter<T>.ConvertFrom_Cac_Person_Envelope(this.envelope));
                
                if (StorageSchema.Cac_Person_Cell_descriptor.check_attribute(StorageSchema.Cac_Person_Cell_descriptor.envelopeseal, attributeKey, attributeValue))
        ...
        {
            return (Cac_Person_Cell_Accessor)this;
        }
        #endregion
        #region Other interfaces
        string ITypeDescriptor.TypeName
        {
            get { return StorageSchema.s_cellTypeName_Cac_Person_Cell; }
        }
        Type ITypeDescriptor.Type
        {
            get { return StorageSchema.s_cellType_Cac_Person_Cell; }
        }
        bool ITypeDescriptor.IsOfType<T>()
        {
            return typeof(T) == StorageSchema.s_cellType_Cac_Person_Cell;
        }
        ...
        {
            return StorageSchema.Cac_Person_Cell.GetFieldDescriptors();
        }
        IAttributeCollection ICellDescriptor.GetFieldAttributes(string fieldName)
        {
            return StorageSchema.Cac_Person_Cell.GetFieldAttributes(fieldName);
        }
        string IAttributeCollection.GetAttributeValue(string attributeKey)
        {
            return StorageSchema.Cac_Person_Cell.GetAttributeValue(attributeKey);
        }
        IReadOnlyDictionary<string, string> IAttributeCollection.Attributes
        {
            get { return StorageSchema.Cac_Person_Cell.Attributes; }
        }
        ...
        ushort ICellDescriptor.CellType
        {
            get
            {
                return (ushort)CellType.Cac_Person_Cell;
            }
        }
        #endregion
    }
    /// <summary>
    /// Provides in-place operations of Cac_Person_Cell defined in TSL.
    /// </summary>
    public unsafe class Cac_Person_Cell_Accessor : ICellAccessor
    {
        #region Fields
        ...
        #endregion
        #region Constructors
        private unsafe Cac_Person_Cell_Accessor()
        {
                    envelope_Accessor_Field = new Cac_Person_Envelope_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        private static unsafe byte[] construct( Cac_Person_Envelope envelope = default(Cac_Person_Envelope) , TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal) )
        {
...
*(optheader_2 + 0) |= 0x08;
        ...
        Cac_Person_Envelope_Accessor envelope_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field envelope.
        ///</summary>
        public unsafe Cac_Person_Envelope_Accessor envelope
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator Cac_Person_Cell(Cac_Person_Cell_Accessor accessor)
        {
            
            return new Cac_Person_Cell(accessor.CellId
        ...
        public unsafe static implicit operator Cac_Person_Cell_Accessor(Cac_Person_Cell field)
        {
            byte* targetPtr = null;
...
*(optheader_2 + 0) |= 0x08;
            ...
            }Cac_Person_Cell_Accessor ret;
            
            ret = Cac_Person_Cell_Accessor._get()._Setup(field.CellId, tmpcellptr, -1, 0, null);
            ret.m_cellId = field.CellId;
            
            return ret;
        }
        
        public static bool operator ==(Cac_Person_Cell_Accessor a, Cac_Person_Cell_Accessor b)
        {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static bool operator ==(Cac_Person_Cell_Accessor a, Cac_Person_Cell b)
        {
            Cac_Person_Cell_Accessor bb = b;
            return (a == bb);
        }
        public static bool operator !=(Cac_Person_Cell_Accessor a, Cac_Person_Cell b)
        {
        ...
        internal unsafe Cac_Person_Cell_Accessor _Lock(long cellId, CellAccessOptions options)
        {
            ushort cellType;
            this.CellId = cellId;
            ...
            switch (eResult)
            {
                ...
                {
                    if (cellType != (ushort)CellType.Cac_Person_Cell)
                    {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        ...
                        eResult                = Global.LocalStorage.AddOrUse(cellId, defaultContent, ref size, (ushort)CellType.Cac_Person_Cell, out this.m_ptr, out this.m_cellEntryIndex);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal unsafe Cac_Person_Cell_Accessor _Lock(long cellId, CellAccessOptions options, LocalTransactionContext tx)
        {
            ushort cellType;
            this.CellId = cellId;
            this.m_options = options;
            ...
            switch (eResult)
            {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        byte[]  defaultContent = construct();
                        int     size           = defaultContent.Length;
                        eResult                = Global.LocalStorage.AddOrUse(tx, cellId, defaultContent, ref size, (ushort)CellType.Cac_Person_Cell, out this.m_ptr, out this.m_cellEntryIndex);
                        if (eResult == TrinityErrorCode.E_WRONG_CELL_TYPE)
                        {
                            _put(this);
                            Throw.wrong_cell_type();
        ...
        private class PoolPolicy : IPooledObjectPolicy<Cac_Person_Cell_Accessor>
        {
            public Cac_Person_Cell_Accessor Create()
            {
                return new Cac_Person_Cell_Accessor();
            }
            public bool Return(Cac_Person_Cell_Accessor obj)
            {
                return !obj.m_IsIterator;
            }
        }
        private static DefaultObjectPool<Cac_Person_Cell_Accessor> s_accessor_pool = new DefaultObjectPool<Cac_Person_Cell_Accessor>(new PoolPolicy());
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Cac_Person_Cell_Accessor _get() => s_accessor_pool.Get();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void _put(Cac_Person_Cell_Accessor item) => s_accessor_pool.Return(item);
        /// <summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Cac_Person_Cell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options)
        {
            this.CellId      = CellId;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Cac_Person_Cell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options, LocalTransactionContext tx)
        {
            this.CellId      = CellId;
            m_cellEntryIndex = entryIndex;
            m_options        = options;
        ...
        /// For internal use only.
        /// </summary>
        internal static Cac_Person_Cell_Accessor AllocIterativeAccessor(CellInfo info, LocalTransactionContext tx)
        {
            Cac_Person_Cell_Accessor accessor = new Cac_Person_Cell_Accessor();
        ...
        /// If write-ahead-log behavior is specified on <see cref="TDW.TRAServer.StorageExtension_Cac_Person_Cell.UseCac_Person_Cell"/>,
        ...
        public void Dispose()
        {
            if (m_cellEntryIndex >= 0)
            {
                ...
                {
                    LocalMemoryStorage.CWriteAheadLog(this.CellId, this.m_ptr, this.CellSize, (ushort)CellType.Cac_Person_Cell, m_options);
                }
                if (!m_IsIterator)
                {
        ...
        /// <summary>Converts a Cac_Person_Cell_Accessor to its string representation, in JSON format.</summary>
        /// <returns>A string representation of the Cac_Person_Cell.</returns>
        public override string ToString()
        {
            return Serializer.ToString(this);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            ...
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                {
                    Cac_Person_Envelope conversion_result = TypeConverter<T>.ConvertTo_Cac_Person_Envelope(value);
        ...
        {
            return (Cac_Person_Cell)this;
        }
    }
    ///<summary>
    ///Provides interfaces for accessing Cac_Person_Cell cells
    ///on <see cref="Trinity.Storage.LocalMemorySotrage"/>.
    static public class StorageExtension_Cac_Person_Cell
    {
        #region IKeyValueStore non logging
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The value of the cell is specified in the method parameters.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellId">A 64-bit cell Id.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this IKeyValueStore storage, long cellId, Cac_Person_Envelope envelope = default(Cac_Person_Envelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(cellId, tmpcell, (ushort)CellType.Cac_Person_Cell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellId">A 64-bit cell Id.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this IKeyValueStore storage, long cellId, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this IKeyValueStore storage, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        ...
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// </summary>
        public unsafe static Cac_Person_Cell LoadCac_Person_Cell(this IKeyValueStore storage, long cellId)
        {
            if (TrinityErrorCode.E_SUCCESS == storage.LoadCell(cellId, out var buff))
            {
                fixed (byte* p = buff)
                {
                    return Cac_Person_Cell_Accessor._get()._Setup(cellId, p, -1, 0);
                }
            }
            else
            {
        ...
        /// the cell as a Cac_Person_Cell. Any changes done to the accessor
        ...
        /// <returns>A <see cref="TDW.TRAServer.Cac_Person_Cell"/> instance.</returns>
        public unsafe static Cac_Person_Cell_Accessor UseCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, long cellId, CellAccessOptions options)
        {
            return Cac_Person_Cell_Accessor._get()._Lock(cellId, options);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a Cac_Person_Cell. Any changes done to the accessor
        ...
        /// <param name="storage">A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".Cac_Person_Cell"/> instance.</returns>
        public unsafe static Cac_Person_Cell_Accessor UseCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            return Cac_Person_Cell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound);
        }
        #endregion
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, Cac_Person_Envelope envelope = default(Cac_Person_Envelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.Cac_Person_Cell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static Cac_Person_Cell LoadCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            using (var cell = Cac_Person_Cell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound))
            {
                return cell;
            }
        }
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>A <see cref="TDW.TRAServer.Cac_Person_Cell"/> instance.</returns>
        public unsafe static Cac_Person_Cell_Accessor UseCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId, CellAccessOptions options)
        {
            return Cac_Person_Cell_Accessor._get()._Lock(cellId, options, tx);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a Cac_Person_Cell. Any changes done to the accessor
        ...
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".Cac_Person_Cell"/> instance.</returns>
        public unsafe static Cac_Person_Cell_Accessor UseCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            return Cac_Person_Cell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx);
        }
        #endregion
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, Cac_Person_Envelope envelope = default(Cac_Person_Envelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(tx, options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.Cac_Person_Cell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, tx, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type Cac_Person_Cell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, Cac_Person_Cell cellContent)
        {
            return SaveCac_Person_Cell(storage, tx, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static Cac_Person_Cell LoadCac_Person_Cell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            using (var cell = Cac_Person_Cell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx))
            {
                return cell;
            }
        }
