...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRAPostalAddressCell defined in TSL.
    /// </summary>
    public partial struct TRAPostalAddressCell : ICell
    {
        ///<summary>
        ///The id of the cell.
        ///</summary>
        public long CellId;
        ///<summary>
        ///Initializes a new instance of TRAPostalAddressCell with the specified parameters.
        ///</summary>
        public TRAPostalAddressCell(long cell_id , TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
        ...
        ///Initializes a new instance of TRAPostalAddressCell with the specified parameters.
        ///</summary>
        public TRAPostalAddressCell( TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
        ...
        public TRAPostalAddressEnvelope envelope;
        
        public TRACredential_EnvelopeSeal envelopeseal;
        
        public static bool operator ==(TRAPostalAddressCell a, TRAPostalAddressCell b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a TRAPostalAddressCell to its
        ...
        /// in input, if the conversion succeeded, or default(TRAPostalAddressCell) if the conversion
        ...
        /// </returns>
        public static bool TryParse(string input, out TRAPostalAddressCell value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRAPostalAddressCell>(input);
                return true;
            }
            catch { value = default(TRAPostalAddressCell); return false; }
        }
        public static TRAPostalAddressCell Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRAPostalAddressCell>(input);
        }
        ///<summary>Converts a TRAPostalAddressCell to its string representation, in JSON format.</summary>
        ///<returns>A string representation of the TRAPostalAddressCell.</returns>
        ...
        public T GetField<T>(string fieldName)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                return TypeConverter<T>.ConvertFrom_TRAPostalAddressEnvelope(this.envelope);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                this.envelope = TypeConverter<T>.ConvertTo_TRAPostalAddressEnvelope(value);
                break;
        ...
        public IEnumerable<KeyValuePair<string, T>> SelectFields<T>(string attributeKey, string attributeValue)
        {
            switch (TypeConverter<T>.type_id)
            {
                ...
                if (StorageSchema.TRAPostalAddressCell_descriptor.check_attribute(StorageSchema.TRAPostalAddressCell_descriptor.envelope, attributeKey, attributeValue))
                    
                        yield return new KeyValuePair<string, T>("envelope", TypeConverter<T>.ConvertFrom_TRAPostalAddressEnvelope(this.envelope));
                
                if (StorageSchema.TRAPostalAddressCell_descriptor.check_attribute(StorageSchema.TRAPostalAddressCell_descriptor.envelopeseal, attributeKey, attributeValue))
                ...
                case 4:
                    {
                        ...
                        yield return TypeConverter<T>.ConvertFrom_TRAPostalAddressEnvelope(this.envelope);
        ...
        {
            return (TRAPostalAddressCell_Accessor)this;
        }
        #endregion
        #region Other interfaces
        string ITypeDescriptor.TypeName
        {
            get { return StorageSchema.s_cellTypeName_TRAPostalAddressCell; }
        }
        Type ITypeDescriptor.Type
        {
            get { return StorageSchema.s_cellType_TRAPostalAddressCell; }
        }
        bool ITypeDescriptor.IsOfType<T>()
        {
            return typeof(T) == StorageSchema.s_cellType_TRAPostalAddressCell;
        }
        ...
        {
            return StorageSchema.TRAPostalAddressCell.GetFieldDescriptors();
        }
        IAttributeCollection ICellDescriptor.GetFieldAttributes(string fieldName)
        {
            return StorageSchema.TRAPostalAddressCell.GetFieldAttributes(fieldName);
        }
        string IAttributeCollection.GetAttributeValue(string attributeKey)
        {
            return StorageSchema.TRAPostalAddressCell.GetAttributeValue(attributeKey);
        }
        IReadOnlyDictionary<string, string> IAttributeCollection.Attributes
        {
            get { return StorageSchema.TRAPostalAddressCell.Attributes; }
        }
        ...
        ushort ICellDescriptor.CellType
        {
            get
            {
                return (ushort)CellType.TRAPostalAddressCell;
            }
        }
        #endregion
    }
    /// <summary>
    /// Provides in-place operations of TRAPostalAddressCell defined in TSL.
    /// </summary>
    public unsafe class TRAPostalAddressCell_Accessor : ICellAccessor
    {
        #region Fields
        ...
        #endregion
        #region Constructors
        private unsafe TRAPostalAddressCell_Accessor()
        {
                    envelope_Accessor_Field = new TRAPostalAddressEnvelope_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        private static unsafe byte[] construct( TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope) , TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal) )
        {
...

{
    ...
    if(envelope.content.Value.context!= null)
    {
        ...
        if(envelope.content.Value.claims.Value.streetAddress!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.streetAddress.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.postOfficeBoxNumber.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.Value.addressLocality!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.addressLocality.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.Value.addressRegion!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.addressRegion.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.Value.addressCountry!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.addressCountry.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.Value.postalCode!= null)
        {
            int strlen_5 = envelope.content.Value.claims.Value.postalCode.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(envelope.content.Value.claims.Value.streetAddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.streetAddress)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.postOfficeBoxNumber)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.Value.addressLocality!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.addressLocality)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.Value.addressRegion!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.addressRegion)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.Value.addressCountry!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.addressCountry)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.Value.postalCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.Value.postalCode)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_2 + 0) |= 0x08;
        ...
        TRAPostalAddressEnvelope_Accessor envelope_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field envelope.
        ///</summary>
        public unsafe TRAPostalAddressEnvelope_Accessor envelope
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRAPostalAddressCell(TRAPostalAddressCell_Accessor accessor)
        {
            
            return new TRAPostalAddressCell(accessor.CellId
        ...
        public unsafe static implicit operator TRAPostalAddressCell_Accessor(TRAPostalAddressCell field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.envelope.content.Value.context!= null)
    {
        ...
        if(field.envelope.content.Value.claims.Value.streetAddress!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.streetAddress.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.postOfficeBoxNumber.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.Value.addressLocality!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.addressLocality.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.Value.addressRegion!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.addressRegion.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.Value.addressCountry!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.addressCountry.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.Value.postalCode!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.Value.postalCode.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(field.envelope.content.Value.claims.Value.streetAddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.streetAddress)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.postOfficeBoxNumber)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.Value.addressLocality!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.addressLocality)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.Value.addressRegion!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.addressRegion)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.Value.addressCountry!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.addressCountry)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.Value.postalCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.Value.postalCode)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_2 + 0) |= 0x08;
            ...
            }TRAPostalAddressCell_Accessor ret;
            
            ret = TRAPostalAddressCell_Accessor._get()._Setup(field.CellId, tmpcellptr, -1, 0, null);
            ret.m_cellId = field.CellId;
            
            return ret;
        }
        
        public static bool operator ==(TRAPostalAddressCell_Accessor a, TRAPostalAddressCell_Accessor b)
        {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static bool operator ==(TRAPostalAddressCell_Accessor a, TRAPostalAddressCell b)
        {
            TRAPostalAddressCell_Accessor bb = b;
            return (a == bb);
        }
        public static bool operator !=(TRAPostalAddressCell_Accessor a, TRAPostalAddressCell b)
        {
        ...
        internal unsafe TRAPostalAddressCell_Accessor _Lock(long cellId, CellAccessOptions options)
        {
            ushort cellType;
            this.CellId = cellId;
            ...
            switch (eResult)
            {
                ...
                {
                    if (cellType != (ushort)CellType.TRAPostalAddressCell)
                    {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        ...
                        eResult                = Global.LocalStorage.AddOrUse(cellId, defaultContent, ref size, (ushort)CellType.TRAPostalAddressCell, out this.m_ptr, out this.m_cellEntryIndex);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal unsafe TRAPostalAddressCell_Accessor _Lock(long cellId, CellAccessOptions options, LocalTransactionContext tx)
        {
            ushort cellType;
            this.CellId = cellId;
            this.m_options = options;
            ...
            switch (eResult)
            {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        byte[]  defaultContent = construct();
                        int     size           = defaultContent.Length;
                        eResult                = Global.LocalStorage.AddOrUse(tx, cellId, defaultContent, ref size, (ushort)CellType.TRAPostalAddressCell, out this.m_ptr, out this.m_cellEntryIndex);
                        if (eResult == TrinityErrorCode.E_WRONG_CELL_TYPE)
                        {
                            _put(this);
                            Throw.wrong_cell_type();
        ...
        private class PoolPolicy : IPooledObjectPolicy<TRAPostalAddressCell_Accessor>
        {
            public TRAPostalAddressCell_Accessor Create()
            {
                return new TRAPostalAddressCell_Accessor();
            }
            public bool Return(TRAPostalAddressCell_Accessor obj)
            {
                return !obj.m_IsIterator;
            }
        }
        private static DefaultObjectPool<TRAPostalAddressCell_Accessor> s_accessor_pool = new DefaultObjectPool<TRAPostalAddressCell_Accessor>(new PoolPolicy());
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static TRAPostalAddressCell_Accessor _get() => s_accessor_pool.Get();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void _put(TRAPostalAddressCell_Accessor item) => s_accessor_pool.Return(item);
        /// <summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TRAPostalAddressCell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options)
        {
            this.CellId      = CellId;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TRAPostalAddressCell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options, LocalTransactionContext tx)
        {
            this.CellId      = CellId;
            m_cellEntryIndex = entryIndex;
            m_options        = options;
        ...
        /// For internal use only.
        /// </summary>
        internal static TRAPostalAddressCell_Accessor AllocIterativeAccessor(CellInfo info, LocalTransactionContext tx)
        {
            TRAPostalAddressCell_Accessor accessor = new TRAPostalAddressCell_Accessor();
        ...
        /// If write-ahead-log behavior is specified on <see cref="TDW.TRAServer.StorageExtension_TRAPostalAddressCell.UseTRAPostalAddressCell"/>,
        ...
        public void Dispose()
        {
            if (m_cellEntryIndex >= 0)
            {
                ...
                {
                    LocalMemoryStorage.CWriteAheadLog(this.CellId, this.m_ptr, this.CellSize, (ushort)CellType.TRAPostalAddressCell, m_options);
                }
                if (!m_IsIterator)
                {
        ...
        /// <summary>Converts a TRAPostalAddressCell_Accessor to its string representation, in JSON format.</summary>
        /// <returns>A string representation of the TRAPostalAddressCell.</returns>
        public override string ToString()
        {
            return Serializer.ToString(this);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            ...
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                {
                    TRAPostalAddressEnvelope conversion_result = TypeConverter<T>.ConvertTo_TRAPostalAddressEnvelope(value);
        ...
        {
            return (TRAPostalAddressCell)this;
        }
    }
    ///<summary>
    ///Provides interfaces for accessing TRAPostalAddressCell cells
    ///on <see cref="Trinity.Storage.LocalMemorySotrage"/>.
    static public class StorageExtension_TRAPostalAddressCell
    {
        #region IKeyValueStore non logging
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The value of the cell is specified in the method parameters.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellId">A 64-bit cell Id.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this IKeyValueStore storage, long cellId, TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(cellId, tmpcell, (ushort)CellType.TRAPostalAddressCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellId">A 64-bit cell Id.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this IKeyValueStore storage, long cellId, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this IKeyValueStore storage, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        ...
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// </summary>
        public unsafe static TRAPostalAddressCell LoadTRAPostalAddressCell(this IKeyValueStore storage, long cellId)
        {
            if (TrinityErrorCode.E_SUCCESS == storage.LoadCell(cellId, out var buff))
            {
                fixed (byte* p = buff)
                {
                    return TRAPostalAddressCell_Accessor._get()._Setup(cellId, p, -1, 0);
                }
            }
            else
            {
        ...
        /// the cell as a TRAPostalAddressCell. Any changes done to the accessor
        ...
        /// <returns>A <see cref="TDW.TRAServer.TRAPostalAddressCell"/> instance.</returns>
        public unsafe static TRAPostalAddressCell_Accessor UseTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId, CellAccessOptions options)
        {
            return TRAPostalAddressCell_Accessor._get()._Lock(cellId, options);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a TRAPostalAddressCell. Any changes done to the accessor
        ...
        /// <param name="storage">A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".TRAPostalAddressCell"/> instance.</returns>
        public unsafe static TRAPostalAddressCell_Accessor UseTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            return TRAPostalAddressCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound);
        }
        #endregion
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.TRAPostalAddressCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static TRAPostalAddressCell LoadTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            using (var cell = TRAPostalAddressCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound))
            {
                return cell;
            }
        }
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>A <see cref="TDW.TRAServer.TRAPostalAddressCell"/> instance.</returns>
        public unsafe static TRAPostalAddressCell_Accessor UseTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId, CellAccessOptions options)
        {
            return TRAPostalAddressCell_Accessor._get()._Lock(cellId, options, tx);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a TRAPostalAddressCell. Any changes done to the accessor
        ...
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".TRAPostalAddressCell"/> instance.</returns>
        public unsafe static TRAPostalAddressCell_Accessor UseTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            return TRAPostalAddressCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx);
        }
        #endregion
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, TRAPostalAddressEnvelope envelope = default(TRAPostalAddressEnvelope), TRACredential_EnvelopeSeal envelopeseal = default(TRACredential_EnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(tx, options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.TRAPostalAddressCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, tx, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRAPostalAddressCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, TRAPostalAddressCell cellContent)
        {
            return SaveTRAPostalAddressCell(storage, tx, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static TRAPostalAddressCell LoadTRAPostalAddressCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            using (var cell = TRAPostalAddressCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx))
            {
                return cell;
            }
        }
