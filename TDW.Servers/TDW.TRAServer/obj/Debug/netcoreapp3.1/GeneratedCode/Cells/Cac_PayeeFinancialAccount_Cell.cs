...

{
    ...
    if(envelope.content.context!= null)
    {
        ...
        if(envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            int strlen_7 = envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID.Length * 2;
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            ...
            *(int*)targetPtr = strlen_7;
            targetPtr += sizeof(int);
            fixed(char* pstr_7 = envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID)
            {
...

{
    ...
    if(field.envelope.content.context!= null)
    {
        ...
        if(field.envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            int strlen_7 = field.envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID.Length * 2;
            targetPtr += strlen_7+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(field.envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            ...
            *(int*)targetPtr = strlen_7;
            targetPtr += sizeof(int);
            fixed(char* pstr_7 = field.envelope.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID)
            {
                Memory.Copy(pstr_7, targetPtr, strlen_7);
                targetPtr += strlen_7;
            }
