...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        /// If write-ahead-log behavior is specified on <see cref="TDW.TRAServer.StorageExtension_TDWCredential.UseTDWCredential"/>,
...
*(optheader_1 + 0) |= 0x01;
        ...
        /// <returns>A <see cref="TDW.TRAServer.TDWCredential"/> instance.</returns>
