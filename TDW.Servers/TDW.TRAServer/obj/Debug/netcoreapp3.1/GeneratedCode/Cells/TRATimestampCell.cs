...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRATimestampCell defined in TSL.
    /// </summary>
    public partial struct TRATimestampCell : ICell
    {
        ///<summary>
        ///The id of the cell.
        ///</summary>
        ...
        /// <summary>
        /// Converts the string representation of a TRATimestampCell to its
        ...
        /// in input, if the conversion succeeded, or default(TRATimestampCell) if the conversion
        ...
        /// </returns>
        public static bool TryParse(string input, out TRATimestampCell value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampCell>(input);
                return true;
            }
            catch { value = default(TRATimestampCell); return false; }
        }
        public static TRATimestampCell Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampCell>(input);
        }
        ///<summary>Converts a TRATimestampCell to its string representation, in JSON format.</summary>
        ///<returns>A string representation of the TRATimestampCell.</returns>
        ...
        public void SetField<T>(string fieldName, T value)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                this.envelope = TypeConverter<T>.ConvertTo_TRATimestampEnvelope(value);
                break;
        ...
        {
            return (TRATimestampCell_Accessor)this;
        }
        #endregion
        #region Other interfaces
        string ITypeDescriptor.TypeName
        {
            get { return StorageSchema.s_cellTypeName_TRATimestampCell; }
        }
        Type ITypeDescriptor.Type
        {
            get { return StorageSchema.s_cellType_TRATimestampCell; }
        }
        bool ITypeDescriptor.IsOfType<T>()
        {
            return typeof(T) == StorageSchema.s_cellType_TRATimestampCell;
        }
        ...
        {
            return StorageSchema.TRATimestampCell.GetFieldDescriptors();
        }
        IAttributeCollection ICellDescriptor.GetFieldAttributes(string fieldName)
        {
            return StorageSchema.TRATimestampCell.GetFieldAttributes(fieldName);
        }
        string IAttributeCollection.GetAttributeValue(string attributeKey)
        {
            return StorageSchema.TRATimestampCell.GetAttributeValue(attributeKey);
        }
        IReadOnlyDictionary<string, string> IAttributeCollection.Attributes
        {
            get { return StorageSchema.TRATimestampCell.Attributes; }
        }
        ...
        ushort ICellDescriptor.CellType
        {
            get
            {
                return (ushort)CellType.TRATimestampCell;
            }
        }
        #endregion
    }
    /// <summary>
    /// Provides in-place operations of TRATimestampCell defined in TSL.
    /// </summary>
    public unsafe class TRATimestampCell_Accessor : ICellAccessor
    {
        #region Fields
        ...
        #endregion
        #region Constructors
        private unsafe TRATimestampCell_Accessor()
        {
                    envelope_Accessor_Field = new TRATimestampEnvelope_Accessor(null,
        ...
        public byte[] ToByteArray()
        {
            ...
            targetPtr += 1;
                ...
                {
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);{            targetPtr += 16;
...

{
    ...
    if(envelope.content.Value.context!= null)
    {
        ...
        }else
        {
            ...
            targetPtr += 8;
targetPtr += 8;
        if(envelope.content.Value.claims.timestamp!= null)
        {
            int strlen_5 = envelope.content.Value.claims.timestamp.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
            ...
            {
            *(long*)targetPtr = envelope.content.Value.claims.ticks;
            targetPtr += 8;

        {
            *(long*)targetPtr = envelope.content.Value.claims.datetime.ToBinary();
            targetPtr += 8;
        }
        ...
        if(envelope.content.Value.claims.timestamp!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.timestamp)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_2 + 0) |= 0x08;
        ...
        TRATimestampEnvelope_Accessor envelope_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field envelope.
        ///</summary>
        public unsafe TRATimestampEnvelope_Accessor envelope
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRATimestampCell(TRATimestampCell_Accessor accessor)
        {
            
            return new TRATimestampCell(accessor.CellId
        ...
        public unsafe static implicit operator TRATimestampCell_Accessor(TRATimestampCell field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.envelope.content.Value.context!= null)
    {
        ...
        }else
        {
            ...
            targetPtr += 8;
targetPtr += 8;
        if(field.envelope.content.Value.claims.timestamp!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.timestamp.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
            ...
            {
            *(long*)targetPtr = field.envelope.content.Value.claims.ticks;
            targetPtr += 8;

        {
            *(long*)targetPtr = field.envelope.content.Value.claims.datetime.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.envelope.content.Value.claims.timestamp!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.timestamp)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_2 + 0) |= 0x08;
            ...
            }TRATimestampCell_Accessor ret;
            
            ret = TRATimestampCell_Accessor._get()._Setup(field.CellId, tmpcellptr, -1, 0, null);
            ret.m_cellId = field.CellId;
            
            return ret;
        }
        
        public static bool operator ==(TRATimestampCell_Accessor a, TRATimestampCell_Accessor b)
        {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static bool operator ==(TRATimestampCell_Accessor a, TRATimestampCell b)
        {
            TRATimestampCell_Accessor bb = b;
            return (a == bb);
        }
        public static bool operator !=(TRATimestampCell_Accessor a, TRATimestampCell b)
        {
        ...
        internal unsafe TRATimestampCell_Accessor _Lock(long cellId, CellAccessOptions options)
        {
            ushort cellType;
            this.CellId = cellId;
            ...
            switch (eResult)
            {
                ...
                {
                    if (cellType != (ushort)CellType.TRATimestampCell)
                    {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        ...
                        eResult                = Global.LocalStorage.AddOrUse(cellId, defaultContent, ref size, (ushort)CellType.TRATimestampCell, out this.m_ptr, out this.m_cellEntryIndex);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal unsafe TRATimestampCell_Accessor _Lock(long cellId, CellAccessOptions options, LocalTransactionContext tx)
        {
            ushort cellType;
            this.CellId = cellId;
            this.m_options = options;
            ...
            switch (eResult)
            {
                ...
                case TrinityErrorCode.E_CELL_NOT_FOUND:
                {
                    ...
                    else if ((options & CellAccessOptions.CreateNewOnCellNotFound) != 0)
                    {
                        byte[]  defaultContent = construct();
                        int     size           = defaultContent.Length;
                        eResult                = Global.LocalStorage.AddOrUse(tx, cellId, defaultContent, ref size, (ushort)CellType.TRATimestampCell, out this.m_ptr, out this.m_cellEntryIndex);
                        if (eResult == TrinityErrorCode.E_WRONG_CELL_TYPE)
                        {
                            _put(this);
                            Throw.wrong_cell_type();
        ...
        private class PoolPolicy : IPooledObjectPolicy<TRATimestampCell_Accessor>
        {
            public TRATimestampCell_Accessor Create()
            {
                return new TRATimestampCell_Accessor();
            }
            public bool Return(TRATimestampCell_Accessor obj)
            {
                return !obj.m_IsIterator;
            }
        }
        private static DefaultObjectPool<TRATimestampCell_Accessor> s_accessor_pool = new DefaultObjectPool<TRATimestampCell_Accessor>(new PoolPolicy());
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static TRATimestampCell_Accessor _get() => s_accessor_pool.Get();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void _put(TRATimestampCell_Accessor item) => s_accessor_pool.Return(item);
        /// <summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TRATimestampCell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options)
        {
            this.CellId      = CellId;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TRATimestampCell_Accessor _Setup(long CellId, byte* cellPtr, int entryIndex, CellAccessOptions options, LocalTransactionContext tx)
        {
            this.CellId      = CellId;
            m_cellEntryIndex = entryIndex;
            m_options        = options;
        ...
        /// For internal use only.
        /// </summary>
        internal static TRATimestampCell_Accessor AllocIterativeAccessor(CellInfo info, LocalTransactionContext tx)
        {
            TRATimestampCell_Accessor accessor = new TRATimestampCell_Accessor();
        ...
        /// If write-ahead-log behavior is specified on <see cref="TDW.TRAServer.StorageExtension_TRATimestampCell.UseTRATimestampCell"/>,
        ...
        public void Dispose()
        {
            if (m_cellEntryIndex >= 0)
            {
                ...
                {
                    LocalMemoryStorage.CWriteAheadLog(this.CellId, this.m_ptr, this.CellSize, (ushort)CellType.TRATimestampCell, m_options);
                }
                if (!m_IsIterator)
                {
        ...
        /// <summary>Converts a TRATimestampCell_Accessor to its string representation, in JSON format.</summary>
        /// <returns>A string representation of the TRATimestampCell.</returns>
        public override string ToString()
        {
            return Serializer.ToString(this);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            ...
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                {
                    TRATimestampEnvelope conversion_result = TypeConverter<T>.ConvertTo_TRATimestampEnvelope(value);
        ...
        {
            return (TRATimestampCell)this;
        }
    }
    ///<summary>
    ///Provides interfaces for accessing TRATimestampCell cells
    ///on <see cref="Trinity.Storage.LocalMemorySotrage"/>.
    static public class StorageExtension_TRATimestampCell
    {
        #region IKeyValueStore non logging
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The value of the cell is specified in the method parameters.
        /// </summary>
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(cellId, tmpcell, (ushort)CellType.TRATimestampCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellId">A 64-bit cell Id.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this IKeyValueStore storage, long cellId, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this IKeyValueStore storage, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        ...
        /// <param name="storage"/>A <see cref="Trinity.Storage.IKeyValueStore"/> instance.</param>
        /// </summary>
        public unsafe static TRATimestampCell LoadTRATimestampCell(this IKeyValueStore storage, long cellId)
        {
            if (TrinityErrorCode.E_SUCCESS == storage.LoadCell(cellId, out var buff))
            {
                fixed (byte* p = buff)
                {
                    return TRATimestampCell_Accessor._get()._Setup(cellId, p, -1, 0);
                }
            }
            else
            {
        ...
        /// the cell as a TRATimestampCell. Any changes done to the accessor
        ...
        /// <returns>A <see cref="TDW.TRAServer.TRATimestampCell"/> instance.</returns>
        public unsafe static TRATimestampCell_Accessor UseTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId, CellAccessOptions options)
        {
            return TRATimestampCell_Accessor._get()._Lock(cellId, options);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a TRATimestampCell. Any changes done to the accessor
        ...
        /// <param name="storage">A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".TRATimestampCell"/> instance.</returns>
        public unsafe static TRATimestampCell_Accessor UseTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            return TRATimestampCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound);
        }
        #endregion
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.TRATimestampCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static TRATimestampCell LoadTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            using (var cell = TRATimestampCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound))
            {
                return cell;
            }
        }
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>A <see cref="TDW.TRAServer.TRATimestampCell"/> instance.</returns>
        public unsafe static TRATimestampCell_Accessor UseTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId, CellAccessOptions options)
        {
            return TRATimestampCell_Accessor._get()._Lock(cellId, options, tx);
        }
        /// <summary>
        /// Allocate a cell accessor on the specified cell, which interprets
        /// the cell as a TRATimestampCell. Any changes done to the accessor
        ...
        /// <param name="cellId">The id of the specified cell.</param>
        /// <returns>A <see cref="" + script.RootNamespace + ".TRATimestampCell"/> instance.</returns>
        public unsafe static TRATimestampCell_Accessor UseTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            return TRATimestampCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx);
        }
        #endregion
...
*(optheader_2 + 0) |= 0x08;
            ...
            return storage.SaveCell(tx, options, cellId, tmpcell, 0, tmpcell.Length, (ushort)CellType.TRATimestampCell) == TrinityErrorCode.E_SUCCESS;
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. The parameter <paramref name="cellId"/> overrides the cell id in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, tx, options, cellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Adds a new cell of type TRATimestampCell to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        /// <param name="cellContent">The content of the cell.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, TRATimestampCell cellContent)
        {
            return SaveTRATimestampCell(storage, tx, options, cellContent.CellId  , cellContent.envelope  , cellContent.envelopeseal );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        /// <param name="storage"/>A <see cref="Trinity.Storage.LocalMemoryStorage"/> instance.</param>
        /// </summary>
        public unsafe static TRATimestampCell LoadTRATimestampCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, long cellId)
        {
            using (var cell = TRATimestampCell_Accessor._get()._Lock(cellId, CellAccessOptions.ThrowExceptionOnCellNotFound, tx))
            {
                return cell;
            }
        }
