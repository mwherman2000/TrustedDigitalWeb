...

{
    ...
    if(envelope.content.Value.context!= null)
    {
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            int strlen_6 = envelope.content.Value.claims.cbc_PaymentMeansCode._listID.Length * 2;
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            int strlen_6 = envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            int strlen_6 = envelope.content.Value.claims.cbc_PaymentMeansCode.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.cbc_PaymentChannel!= null)
        {
            int strlen_5 = envelope.content.Value.claims.cbc_PaymentChannel.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.cbc_PaymentID!= null)
        {
            int strlen_5 = envelope.content.Value.claims.cbc_PaymentID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(envelope.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            int strlen_5 = envelope.content.Value.claims.cac_PayeeFinancialAccountUdid.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.Value.claims.cbc_PaymentMeansCode._listID)
            {
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(envelope.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.Value.claims.cbc_PaymentMeansCode.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        {
            *(long*)targetPtr = envelope.content.Value.claims.cbc_PaymentDueDate.ToBinary();
            targetPtr += 8;
        }
        ...
        if(envelope.content.Value.claims.cbc_PaymentChannel!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.cbc_PaymentChannel)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.cbc_PaymentID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.cbc_PaymentID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(envelope.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.cac_PayeeFinancialAccountUdid)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...

{
    ...
    if(field.envelope.content.Value.context!= null)
    {
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            int strlen_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode._listID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            int strlen_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            int strlen_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentChannel!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.cbc_PaymentChannel.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentID!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.cbc_PaymentID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.cac_PayeeFinancialAccountUdid.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode._listID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode._listAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.Value.claims.cbc_PaymentMeansCode.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        {
            *(long*)targetPtr = field.envelope.content.Value.claims.cbc_PaymentDueDate.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentChannel!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.cbc_PaymentChannel)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.cbc_PaymentID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.cbc_PaymentID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.envelope.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.cac_PayeeFinancialAccountUdid)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
