...

{
    ...
    if(envelope.content.Value.context!= null)
    {
        ...
        }else
        {
            ...
            {
            targetPtr += 1;
            if( envelope.content.Value.claims.cbc_URI!= null)
            {

        if(envelope.content.Value.claims.cbc_URI!= null)
        {
            int strlen_5 = envelope.content.Value.claims.cbc_URI.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject!= null)
            {

            {

        if(envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            int strlen_6 = envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode.Length * 2;
        ...
        if(envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            int strlen_6 = envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(envelope.content.Value.claims.cbc_URI!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = envelope.content.Value.claims.cbc_URI)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_4 + 0) |= 0x01;
        ...
        if(envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode)
            {
        ...
        if(envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...

{
    ...
    if(field.envelope.content.Value.context!= null)
    {
        ...
        }else
        {
            ...
            {
            targetPtr += 1;
            if( field.envelope.content.Value.claims.cbc_URI!= null)
            {

        if(field.envelope.content.Value.claims.cbc_URI!= null)
        {
            int strlen_5 = field.envelope.content.Value.claims.cbc_URI.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject!= null)
            {

            {

        if(field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            int strlen_6 = field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            int strlen_6 = field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
        ...
        if(field.envelope.content.Value.claims.cbc_URI!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.envelope.content.Value.claims.cbc_URI)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_4 + 0) |= 0x01;
        ...
        if(field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.envelope.content.Value.claims.cbc_EmbeddedDocumentBinaryObject.Value.binary16)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
