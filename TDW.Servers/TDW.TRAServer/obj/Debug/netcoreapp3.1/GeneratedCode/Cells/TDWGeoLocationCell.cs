...
namespace TDW.TRAServer
{
    ...
    public partial struct TDWGeoLocationCell : ICell
    {
        ...
        ///</summary>
        public TDWGeoLocationCell(long cell_id , TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope), TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal))
        {
        ...
        ///Initializes a new instance of TDWGeoLocationCell with the specified parameters.
        ///</summary>
        public TDWGeoLocationCell( TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope), TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal))
        {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        private static unsafe byte[] construct( TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope) , TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal) )
        {
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
            ...
            {
            *(double*)targetPtr = envelope.content.Value.claims.latitude;
            targetPtr += 8;
            *(double*)targetPtr = envelope.content.Value.claims.longitude;
            targetPtr += 8;
...
*(int*)storedPtr_4 = (int)(targetPtr - storedPtr_4 - 4);
            ...
            {
            *(double*)targetPtr = field.envelope.content.Value.claims.latitude;
            targetPtr += 8;
            *(double*)targetPtr = field.envelope.content.Value.claims.longitude;
            targetPtr += 8;
...
targetPtr += *(int*)targetPtr + sizeof(int);
    ...
    static public class StorageExtension_TDWGeoLocationCell
    {
        ...
        public unsafe static bool SaveTDWGeoLocationCell(this IKeyValueStore storage, long cellId, TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope), TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTDWGeoLocationCell(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope), TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal))
        {
...
*(optheader_2 + 0) |= 0x08;
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveTDWGeoLocationCell(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, TRAGeoLocationEnvelope envelope = default(TRAGeoLocationEnvelope), TRACredentialEnvelopeSeal envelopeseal = default(TRACredentialEnvelopeSeal))
        {
