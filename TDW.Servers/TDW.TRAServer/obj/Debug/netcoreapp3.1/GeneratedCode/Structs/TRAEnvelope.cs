...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRAEnvelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TRAEnvelope
    {
        
        ///<summary>
        ///Initializes a new instance of TRAEnvelope with the specified parameters.
        ///</summary>
        public TRAEnvelope(TRACredentialType credtype = default(TRACredentialType),TRAEncryptionFlag encryptionFlag = default(TRAEncryptionFlag),string hashedThumbprint64 = default(string),string signedHashSignature64 = default(string),string notaryStamp = default(string),List<string> comments = default(List<string>))
        {
        ...
        public static bool operator ==(TRAEnvelope a, TRAEnvelope b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a TRAEnvelope to its
        ...
        /// in input, if the conversion succeeded, or default(TRAEnvelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRAEnvelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRAEnvelope>(input);
                return true;
            }
            catch { value = default(TRAEnvelope); return false; }
        }
        public static TRAEnvelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRAEnvelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRAEnvelope defined in TSL.
    /// </summary>
    public unsafe partial class TRAEnvelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRAEnvelope_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRAEnvelope(TRAEnvelope_Accessor accessor)
        {
        ...
        public unsafe static implicit operator TRAEnvelope_Accessor(TRAEnvelope field)
        {
            byte* targetPtr = null;
...
*(optheader_1 + 0) |= 0x08;
            ...
            }TRAEnvelope_Accessor ret;
            
            ret = new TRAEnvelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRAEnvelope_Accessor a, TRAEnvelope_Accessor b)
        {
