...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_Person_Content defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_Person_Content
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_Person_Content with the specified parameters.
        ///</summary>
        public Cac_Person_Content(string udid = default(string),List<string> context = default(List<string>),Cac_Person_Claims? claims = default(Cac_Person_Claims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(Cac_Person_Content a, Cac_Person_Content b)
        {
        ...
        public Cac_Person_Claims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a Cac_Person_Content to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_Person_Content) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_Person_Content value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Person_Content>(input);
                return true;
            }
            catch { value = default(Cac_Person_Content); return false; }
        }
        public static Cac_Person_Content Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Person_Content>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_Person_Content defined in TSL.
    /// </summary>
    public unsafe partial class Cac_Person_Content_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_Person_Content_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new Cac_Person_Claims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        Cac_Person_Claims_Accessor claims_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe Cac_Person_Claims_Accessor claims
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator Cac_Person_Content(Cac_Person_Content_Accessor accessor)
        {
            Cac_Person_Claims? _claims = default(Cac_Person_Claims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (Cac_Person_Claims)accessor.claims;
        ...
        public unsafe static implicit operator Cac_Person_Content_Accessor(Cac_Person_Content field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.context!= null)
    {
        ...
        if(field.claims.Value.cbc_FirstName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_FirstName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_MiddleName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_MiddleName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_FamilyName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_FamilyName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_JobTitle!= null)
        {
            int strlen_3 = field.claims.Value.cbc_JobTitle.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.cbc_FirstName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_FirstName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_MiddleName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_MiddleName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_FamilyName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_FamilyName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_JobTitle!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_JobTitle)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }Cac_Person_Content_Accessor ret;
            
            ret = new Cac_Person_Content_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_Person_Content_Accessor a, Cac_Person_Content_Accessor b)
        {
