...
namespace TDW.TRAServer
{
    ...
    public partial struct TRACredential_Envelope
    {
        ...
        ///</summary>
        public TRACredential_Envelope(TRACredential_Content? content = default(TRACredential_Content?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        {
            TRACredential_Content? _content = default(TRACredential_Content?);
            if (accessor.Contains_content)
            {
                
                _content = (TRACredential_Content)accessor.content;
