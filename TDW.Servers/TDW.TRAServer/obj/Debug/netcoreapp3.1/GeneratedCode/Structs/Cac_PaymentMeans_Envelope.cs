...
namespace TDW.TRAServer
{
    ...
    public partial struct Cac_PaymentMeans_Envelope
    {
        ...
        ///</summary>
        public Cac_PaymentMeans_Envelope(Cac_PaymentMeans_EnvelopeContent content = default(Cac_PaymentMeans_EnvelopeContent),TRACredential_PackingLabel label = default(TRACredential_PackingLabel))
        {
...

{
    ...
    if(field.content.context!= null)
    {
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode._listID!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_PaymentMeansCode._listID.Length * 2;
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_PaymentMeansCode._listAgencyID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode.code!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_PaymentMeansCode.code.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PaymentChannel!= null)
        {
            int strlen_4 = field.content.claims.Value.cbc_PaymentChannel.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PaymentID!= null)
        {
            int strlen_4 = field.content.claims.Value.cbc_PaymentID.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cac_PayeeFinancialAccountUdid!= null)
        {
            int strlen_4 = field.content.claims.Value.cac_PayeeFinancialAccountUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(optheader_2 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode._listID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_PaymentMeansCode._listID)
            {
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_PaymentMeansCode._listAgencyID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.content.claims.Value.cbc_PaymentMeansCode.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_PaymentMeansCode.code)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        {
            *(long*)targetPtr = field.content.claims.Value.cbc_PaymentDueDate.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.content.claims.Value.cbc_PaymentChannel!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cbc_PaymentChannel)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cbc_PaymentID!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cbc_PaymentID)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cac_PayeeFinancialAccountUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cac_PayeeFinancialAccountUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
