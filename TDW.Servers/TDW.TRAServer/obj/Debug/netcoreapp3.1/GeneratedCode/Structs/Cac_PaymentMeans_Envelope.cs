...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_PaymentMeans_Envelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_PaymentMeans_Envelope
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_PaymentMeans_Envelope with the specified parameters.
        ///</summary>
        public Cac_PaymentMeans_Envelope(Cac_PaymentMeans_Content? content = default(Cac_PaymentMeans_Content?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public static bool operator ==(Cac_PaymentMeans_Envelope a, Cac_PaymentMeans_Envelope b)
        {
        ...
        /// in input, if the conversion succeeded, or default(Cac_PaymentMeans_Envelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_PaymentMeans_Envelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PaymentMeans_Envelope>(input);
                return true;
            }
            catch { value = default(Cac_PaymentMeans_Envelope); return false; }
        }
        public static Cac_PaymentMeans_Envelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PaymentMeans_Envelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_PaymentMeans_Envelope defined in TSL.
    /// </summary>
    public unsafe partial class Cac_PaymentMeans_Envelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_PaymentMeans_Envelope_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator Cac_PaymentMeans_Envelope(Cac_PaymentMeans_Envelope_Accessor accessor)
        {
            Cac_PaymentMeans_Content? _content = default(Cac_PaymentMeans_Content?);
            if (accessor.Contains_content)
            {
                
                _content = (Cac_PaymentMeans_Content)accessor.content;
            ...
            return new Cac_PaymentMeans_Envelope(
        ...
        public unsafe static implicit operator Cac_PaymentMeans_Envelope_Accessor(Cac_PaymentMeans_Envelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            int strlen_5 = field.content.Value.claims.cbc_PaymentMeansCode._listID.Length * 2;
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            int strlen_5 = field.content.Value.claims.cbc_PaymentMeansCode._listAgencyID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            int strlen_5 = field.content.Value.claims.cbc_PaymentMeansCode.code.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_PaymentChannel!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_PaymentChannel.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_PaymentID!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_PaymentID.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            int strlen_4 = field.content.Value.claims.cac_PayeeFinancialAccountUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode._listID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.Value.claims.cbc_PaymentMeansCode._listID)
            {
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode._listAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.Value.claims.cbc_PaymentMeansCode._listAgencyID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.content.Value.claims.cbc_PaymentMeansCode.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.Value.claims.cbc_PaymentMeansCode.code)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        {
            *(long*)targetPtr = field.content.Value.claims.cbc_PaymentDueDate.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.content.Value.claims.cbc_PaymentChannel!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_PaymentChannel)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_PaymentID!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_PaymentID)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cac_PayeeFinancialAccountUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cac_PayeeFinancialAccountUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
...
*(optheader_2 + 0) |= 0x02;
            ...
            }Cac_PaymentMeans_Envelope_Accessor ret;
            
            ret = new Cac_PaymentMeans_Envelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_PaymentMeans_Envelope_Accessor a, Cac_PaymentMeans_Envelope_Accessor b)
        {
