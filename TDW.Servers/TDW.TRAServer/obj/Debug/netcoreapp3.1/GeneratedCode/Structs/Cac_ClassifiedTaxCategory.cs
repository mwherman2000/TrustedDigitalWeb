...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_ClassifiedTaxCategory defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_ClassifiedTaxCategory
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_ClassifiedTaxCategory with the specified parameters.
        ///</summary>
        public Cac_ClassifiedTaxCategory(Cbc_SchemeCode cbc_ID = default(Cbc_SchemeCode),double cbc_Percent = default(double),Cac_TaxScheme cac_TaxScheme = default(Cac_TaxScheme))
        {
        ...
        public static bool operator ==(Cac_ClassifiedTaxCategory a, Cac_ClassifiedTaxCategory b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a Cac_ClassifiedTaxCategory to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_ClassifiedTaxCategory) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_ClassifiedTaxCategory value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_ClassifiedTaxCategory>(input);
                return true;
            }
            catch { value = default(Cac_ClassifiedTaxCategory); return false; }
        }
        public static Cac_ClassifiedTaxCategory Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_ClassifiedTaxCategory>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_ClassifiedTaxCategory defined in TSL.
    /// </summary>
    public unsafe partial class Cac_ClassifiedTaxCategory_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_ClassifiedTaxCategory_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);}            targetPtr += 8;
        ...
        public static unsafe implicit operator Cac_ClassifiedTaxCategory(Cac_ClassifiedTaxCategory_Accessor accessor)
        {
            
            return new Cac_ClassifiedTaxCategory(
        ...
        public unsafe static implicit operator Cac_ClassifiedTaxCategory_Accessor(Cac_ClassifiedTaxCategory field)
        {
            byte* targetPtr = null;
...
*(optheader_3 + 0) |= 0x01;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }Cac_ClassifiedTaxCategory_Accessor ret;
            
            ret = new Cac_ClassifiedTaxCategory_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_ClassifiedTaxCategory_Accessor a, Cac_ClassifiedTaxCategory_Accessor b)
        {
