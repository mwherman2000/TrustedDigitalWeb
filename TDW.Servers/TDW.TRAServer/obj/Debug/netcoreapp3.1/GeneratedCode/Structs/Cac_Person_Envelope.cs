...
namespace TDW.TRAServer
{
    ...
    public partial struct Cac_Person_Envelope
    {
        ...
        ///</summary>
        public Cac_Person_Envelope(Cac_Person_Content? content = default(Cac_Person_Content?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public Cac_Person_Content? content;
    ...
    public unsafe partial class Cac_Person_Envelope_Accessor : IAccessor
    {
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_Person_Content_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_Person_Content_Accessor content_Accessor_Field;
        ...
        ///</summary>
        public unsafe Cac_Person_Content_Accessor content
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        {
            Cac_Person_Content? _content = default(Cac_Person_Content?);
            if (accessor.Contains_content)
            {
                
                _content = (Cac_Person_Content)accessor.content;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.cbc_FirstName!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_FirstName.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_MiddleName!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_MiddleName.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_FamilyName!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_FamilyName.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_JobTitle!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_JobTitle.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.cbc_FirstName!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_FirstName)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_MiddleName!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_MiddleName)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_FamilyName!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_FamilyName)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_JobTitle!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_JobTitle)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
