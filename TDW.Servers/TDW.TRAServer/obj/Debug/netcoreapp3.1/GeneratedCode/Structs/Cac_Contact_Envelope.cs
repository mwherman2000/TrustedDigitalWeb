...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_Contact_Envelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_Contact_Envelope
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_Contact_Envelope with the specified parameters.
        ///</summary>
        public Cac_Contact_Envelope(Cac_Contact_Content? content = default(Cac_Contact_Content?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public static bool operator ==(Cac_Contact_Envelope a, Cac_Contact_Envelope b)
        {
        ...
        public Cac_Contact_Content? content;
        ...
        /// <summary>
        /// Converts the string representation of a Cac_Contact_Envelope to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_Contact_Envelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_Contact_Envelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Contact_Envelope>(input);
                return true;
            }
            catch { value = default(Cac_Contact_Envelope); return false; }
        }
        public static Cac_Contact_Envelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_Contact_Envelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_Contact_Envelope defined in TSL.
    /// </summary>
    public unsafe partial class Cac_Contact_Envelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_Contact_Envelope_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_Contact_Content_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_Contact_Content_Accessor content_Accessor_Field;
        ...
        ///</summary>
        public unsafe Cac_Contact_Content_Accessor content
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator Cac_Contact_Envelope(Cac_Contact_Envelope_Accessor accessor)
        {
            Cac_Contact_Content? _content = default(Cac_Contact_Content?);
            if (accessor.Contains_content)
            {
                
                _content = (Cac_Contact_Content)accessor.content;
            ...
            return new Cac_Contact_Envelope(
        ...
        public unsafe static implicit operator Cac_Contact_Envelope_Accessor(Cac_Contact_Envelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.cbc_Telephone!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_Telephone.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_Telefax!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_Telefax.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.cbc_ElectronicMail!= null)
        {
            int strlen_4 = field.content.Value.claims.cbc_ElectronicMail.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.cbc_Telephone!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_Telephone)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_Telefax!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_Telefax)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.cbc_ElectronicMail!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.cbc_ElectronicMail)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
...
*(optheader_2 + 0) |= 0x02;
            ...
            }Cac_Contact_Envelope_Accessor ret;
            
            ret = new Cac_Contact_Envelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_Contact_Envelope_Accessor a, Cac_Contact_Envelope_Accessor b)
        {
