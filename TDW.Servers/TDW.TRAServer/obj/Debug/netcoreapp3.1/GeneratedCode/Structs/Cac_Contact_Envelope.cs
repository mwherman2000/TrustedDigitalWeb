...
namespace TDW.TRAServer
{
    ...
    public partial struct Cac_Contact_Envelope
    {
        ...
        ///</summary>
        public Cac_Contact_Envelope(Cac_Contact_EnvelopeContent content = default(Cac_Contact_EnvelopeContent),TRACredential_EnvelopeLabel label = default(TRACredential_EnvelopeLabel))
        {
        ...
        public Cac_Contact_EnvelopeContent content;
    ...
    public unsafe partial class Cac_Contact_Envelope_Accessor : IAccessor
    {
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_Contact_EnvelopeContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_Contact_EnvelopeContent_Accessor content_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field content.
        ///</summary>
        public unsafe Cac_Contact_EnvelopeContent_Accessor content
        {
            get
            {
...

{
    ...
    if(field.content.context!= null)
    {
        ...
        if(field.content.claims.Value.cbc_Telephone!= null)
        {
            int strlen_4 = field.content.claims.Value.cbc_Telephone.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_Telefax!= null)
        {
            int strlen_4 = field.content.claims.Value.cbc_Telefax.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_ElectronicMail!= null)
        {
            int strlen_4 = field.content.claims.Value.cbc_ElectronicMail.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(optheader_2 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_Telephone!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cbc_Telephone)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cbc_Telefax!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cbc_Telefax)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cbc_ElectronicMail!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cbc_ElectronicMail)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
