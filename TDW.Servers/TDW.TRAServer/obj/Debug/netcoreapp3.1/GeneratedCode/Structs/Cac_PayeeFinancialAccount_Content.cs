...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_PayeeFinancialAccount_Content defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_PayeeFinancialAccount_Content
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_PayeeFinancialAccount_Content with the specified parameters.
        ///</summary>
        public Cac_PayeeFinancialAccount_Content(string udid = default(string),List<string> context = default(List<string>),Cac_PayeeFinancialAccount_Claims? claims = default(Cac_PayeeFinancialAccount_Claims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(Cac_PayeeFinancialAccount_Content a, Cac_PayeeFinancialAccount_Content b)
        {
        ...
        public Cac_PayeeFinancialAccount_Claims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a Cac_PayeeFinancialAccount_Content to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_PayeeFinancialAccount_Content) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_PayeeFinancialAccount_Content value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PayeeFinancialAccount_Content>(input);
                return true;
            }
            catch { value = default(Cac_PayeeFinancialAccount_Content); return false; }
        }
        public static Cac_PayeeFinancialAccount_Content Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PayeeFinancialAccount_Content>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_PayeeFinancialAccount_Content defined in TSL.
    /// </summary>
    public unsafe partial class Cac_PayeeFinancialAccount_Content_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_PayeeFinancialAccount_Content_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new Cac_PayeeFinancialAccount_Claims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        Cac_PayeeFinancialAccount_Claims_Accessor claims_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe Cac_PayeeFinancialAccount_Claims_Accessor claims
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);{{targetPtr += *(int*)targetPtr + sizeof(int);}}}
        ...
        public static unsafe implicit operator Cac_PayeeFinancialAccount_Content(Cac_PayeeFinancialAccount_Content_Accessor accessor)
        {
            Cac_PayeeFinancialAccount_Claims? _claims = default(Cac_PayeeFinancialAccount_Claims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (Cac_PayeeFinancialAccount_Claims)accessor.claims;
            ...
            return new Cac_PayeeFinancialAccount_Content(
        ...
        public unsafe static implicit operator Cac_PayeeFinancialAccount_Content_Accessor(Cac_PayeeFinancialAccount_Content field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.context!= null)
    {
        ...
        if(field.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            int strlen_5 = field.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID.Length * 2;
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID)
            {
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }Cac_PayeeFinancialAccount_Content_Accessor ret;
            
            ret = new Cac_PayeeFinancialAccount_Content_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_PayeeFinancialAccount_Content_Accessor a, Cac_PayeeFinancialAccount_Content_Accessor b)
        {
