...
namespace TDW.TRAServer
{
    ...
    public partial struct TRATimestampEnvelope
    {
        ...
        ///</summary>
        public TRATimestampEnvelope(TRATimestampContent? content = default(TRATimestampContent?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
