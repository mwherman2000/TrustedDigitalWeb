...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRATimestampEnvelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TRATimestampEnvelope
    {
        
        ///<summary>
        ///Initializes a new instance of TRATimestampEnvelope with the specified parameters.
        ///</summary>
        public TRATimestampEnvelope(TRATimestampContent? content = default(TRATimestampContent?),string encryptedcontent = default(string),TRACredentialMetadata metadata = default(TRACredentialMetadata))
        {
        ...
        public static bool operator ==(TRATimestampEnvelope a, TRATimestampEnvelope b)
        {
        ...
        public TRATimestampContent? content;
        ...
        /// <summary>
        /// Converts the string representation of a TRATimestampEnvelope to its
        ...
        /// in input, if the conversion succeeded, or default(TRATimestampEnvelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRATimestampEnvelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampEnvelope>(input);
                return true;
            }
            catch { value = default(TRATimestampEnvelope); return false; }
        }
        public static TRATimestampEnvelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampEnvelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRATimestampEnvelope defined in TSL.
    /// </summary>
    public unsafe partial class TRATimestampEnvelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRATimestampEnvelope_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new TRATimestampContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        TRATimestampContent_Accessor content_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);}}
        ...
        ///</summary>
        public unsafe TRATimestampContent_Accessor content
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRATimestampEnvelope(TRATimestampEnvelope_Accessor accessor)
        {
            TRATimestampContent? _content = default(TRATimestampContent?);
            if (accessor.Contains_content)
            {
                
                _content = (TRATimestampContent)accessor.content;
            ...
            return new TRATimestampEnvelope(
        ...
        public unsafe static implicit operator TRATimestampEnvelope_Accessor(TRATimestampEnvelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        }else
        {
            ...
            targetPtr += 8;
targetPtr += 8;
        if(field.content.Value.claims.timestamp!= null)
        {
            int strlen_4 = field.content.Value.claims.timestamp.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
            ...
            {
            *(long*)targetPtr = field.content.Value.claims.ticks;
            targetPtr += 8;

        {
            *(long*)targetPtr = field.content.Value.claims.datetime.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.content.Value.claims.timestamp!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.timestamp)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
...
*(optheader_2 + 0) |= 0x02;
            ...
            }TRATimestampEnvelope_Accessor ret;
            
            ret = new TRATimestampEnvelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRATimestampEnvelope_Accessor a, TRATimestampEnvelope_Accessor b)
        {
