...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRATimestampContent defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TRATimestampContent
    {
        
        ///<summary>
        ///Initializes a new instance of TRATimestampContent with the specified parameters.
        ///</summary>
        public TRATimestampContent(string udid = default(string),List<string> context = default(List<string>),TRATimestampClaims? claims = default(TRATimestampClaims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(TRATimestampContent a, TRATimestampContent b)
        {
        ...
        public TRATimestampClaims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a TRATimestampContent to its
        ...
        /// in input, if the conversion succeeded, or default(TRATimestampContent) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRATimestampContent value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampContent>(input);
                return true;
            }
            catch { value = default(TRATimestampContent); return false; }
        }
        public static TRATimestampContent Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRATimestampContent>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRATimestampContent defined in TSL.
    /// </summary>
    public unsafe partial class TRATimestampContent_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRATimestampContent_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new TRATimestampClaims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        TRATimestampClaims_Accessor claims_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe TRATimestampClaims_Accessor claims
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator TRATimestampContent(TRATimestampContent_Accessor accessor)
        {
            TRATimestampClaims? _claims = default(TRATimestampClaims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (TRATimestampClaims)accessor.claims;
            ...
            return new TRATimestampContent(
        ...
        public unsafe static implicit operator TRATimestampContent_Accessor(TRATimestampContent field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.context!= null)
    {
        ...
        }else
        {
            ...
            targetPtr += 8;
targetPtr += 8;
        if(field.claims.Value.timestamp!= null)
        {
            int strlen_3 = field.claims.Value.timestamp.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
            ...
            {
            *(long*)targetPtr = field.claims.Value.ticks;
            targetPtr += 8;

        {
            *(long*)targetPtr = field.claims.Value.datetime.ToBinary();
            targetPtr += 8;
        }
        ...
        if(field.claims.Value.timestamp!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.timestamp)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TRATimestampContent_Accessor ret;
            
            ret = new TRATimestampContent_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRATimestampContent_Accessor a, TRATimestampContent_Accessor b)
        {
