...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_ExternalReference_Content defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_ExternalReference_Content
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_ExternalReference_Content with the specified parameters.
        ///</summary>
        public Cac_ExternalReference_Content(string udid = default(string),List<string> context = default(List<string>),Cac_ExternalReference_Claims? claims = default(Cac_ExternalReference_Claims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(Cac_ExternalReference_Content a, Cac_ExternalReference_Content b)
        {
        ...
        public Cac_ExternalReference_Claims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a Cac_ExternalReference_Content to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_ExternalReference_Content) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_ExternalReference_Content value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_ExternalReference_Content>(input);
                return true;
            }
            catch { value = default(Cac_ExternalReference_Content); return false; }
        }
        public static Cac_ExternalReference_Content Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_ExternalReference_Content>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_ExternalReference_Content defined in TSL.
    /// </summary>
    public unsafe partial class Cac_ExternalReference_Content_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_ExternalReference_Content_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new Cac_ExternalReference_Claims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        Cac_ExternalReference_Claims_Accessor claims_Accessor_Field;
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe Cac_ExternalReference_Claims_Accessor claims
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator Cac_ExternalReference_Content(Cac_ExternalReference_Content_Accessor accessor)
        {
            Cac_ExternalReference_Claims? _claims = default(Cac_ExternalReference_Claims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (Cac_ExternalReference_Claims)accessor.claims;
            ...
            return new Cac_ExternalReference_Content(
        ...
        public unsafe static implicit operator Cac_ExternalReference_Content_Accessor(Cac_ExternalReference_Content field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.context!= null)
    {
        ...
        }else
        {
            ...
            {
            targetPtr += 1;
            if( field.claims.Value.cbc_URI!= null)
            {

        if(field.claims.Value.cbc_URI!= null)
        {
            int strlen_3 = field.claims.Value.cbc_URI.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
            ...
            if( field.claims.Value.cbc_EmbeddedDocumentBinaryObject!= null)
            {

            {

        if(field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            int strlen_4 = field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode.Length * 2;
        ...
        if(field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            int strlen_4 = field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value.binary16.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.cbc_URI!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_URI)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
...
*(optheader_2 + 0) |= 0x01;
        ...
        if(field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value._mimeCode)
            {
        ...
        if(field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value.binary16!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.claims.Value.cbc_EmbeddedDocumentBinaryObject.Value.binary16)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }Cac_ExternalReference_Content_Accessor ret;
            
            ret = new Cac_ExternalReference_Content_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_ExternalReference_Content_Accessor a, Cac_ExternalReference_Content_Accessor b)
        {
