...
namespace TDW.TRAServer
{
    ...
    public unsafe partial class Cac_Party_Envelope_Accessor : IAccessor
    {
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_Party_EnvelopeContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_Party_EnvelopeContent_Accessor content_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field content.
        ///</summary>
        public unsafe Cac_Party_EnvelopeContent_Accessor content
        {
            get
            {
...

{
    ...
    if(field.content.context!= null)
    {
        ...
        if(field.content.claims.Value.cbc_EndpointID._schemeID!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_EndpointID._schemeID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.content.claims.Value.cbc_EndpointID._schemeAgencyID!= null)
            {

        if(field.content.claims.Value.cbc_EndpointID._schemeAgencyID!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_EndpointID._schemeAgencyID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_EndpointID.code!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_EndpointID.code.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeID!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeAgencyID!= null)
            {

        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeAgencyID!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID.code!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyName.cbc_Name!= null)
        {
            int strlen_5 = field.content.claims.Value.cbc_PartyName.cbc_Name.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cac_PostalAddressUdid!= null)
        {
            int strlen_4 = field.content.claims.Value.cac_PostalAddressUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeID!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeAgencyID!= null)
            {

        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeAgencyID!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeAgencyID.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID.code!= null)
        {
            int strlen_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID.code.Length * 2;
            targetPtr += strlen_6+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeID!= null)
        {
            int strlen_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeID.Length * 2;
            targetPtr += strlen_7+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        }
            if( field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeAgencyID!= null)
            {

        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeAgencyID!= null)
        {
            int strlen_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeAgencyID.Length * 2;
            targetPtr += strlen_7+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID.code!= null)
        {
            int strlen_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID.code.Length * 2;
            targetPtr += strlen_7+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cac_PartyLegalEntityUdid!= null)
        {
            int strlen_4 = field.content.claims.Value.cac_PartyLegalEntityUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cac_ContactUdid!= null)
        {
            int strlen_4 = field.content.claims.Value.cac_ContactUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.claims.Value.cac_PersonUdid!= null)
        {
            int strlen_4 = field.content.claims.Value.cac_PersonUdid.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(optheader_2 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_EndpointID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_EndpointID._schemeID)
            {
        ...
        if(field.content.claims.Value.cbc_EndpointID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_EndpointID._schemeAgencyID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
...
*(optheader_4 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_EndpointID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_EndpointID.code)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeID)
            {
        ...
        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID._schemeAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...
*(optheader_5 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_PartyIdentification.cbc_ID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyIdentification.cbc_ID.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.content.claims.Value.cbc_PartyName.cbc_Name!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.content.claims.Value.cbc_PartyName.cbc_Name)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.content.claims.Value.cac_PostalAddressUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cac_PostalAddressUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID._schemeAgencyID)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
...
*(optheader_5 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cbc_PartyTaxScheme.cbc_CompanyID.code)
            {
                Memory.Copy(pstr_6, targetPtr, strlen_6);
                targetPtr += strlen_6;
            }
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeID!= null)
        {
            ...
            *(int*)targetPtr = strlen_7;
            targetPtr += sizeof(int);
            fixed(char* pstr_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeID)
            {
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_7;
            targetPtr += sizeof(int);
            fixed(char* pstr_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID._schemeAgencyID)
            {
                Memory.Copy(pstr_7, targetPtr, strlen_7);
                targetPtr += strlen_7;
            }
...
*(optheader_6 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_7;
            targetPtr += sizeof(int);
            fixed(char* pstr_7 = field.content.claims.Value.cbc_PartyTaxScheme.cac_TaxScheme.cbc_ID.code)
            {
                Memory.Copy(pstr_7, targetPtr, strlen_7);
                targetPtr += strlen_7;
            }
        ...
        if(field.content.claims.Value.cac_PartyLegalEntityUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cac_PartyLegalEntityUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cac_ContactUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cac_ContactUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.claims.Value.cac_PersonUdid!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.claims.Value.cac_PersonUdid)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
