...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRAPostalAddressEnvelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TRAPostalAddressEnvelope
    {
        
        ///<summary>
        ///Initializes a new instance of TRAPostalAddressEnvelope with the specified parameters.
        ///</summary>
        public TRAPostalAddressEnvelope(TRAPostalAddressContent? content = default(TRAPostalAddressContent?),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public static bool operator ==(TRAPostalAddressEnvelope a, TRAPostalAddressEnvelope b)
        {
        ...
        public TRAPostalAddressContent? content;
        
        public TRACredential_Label label;
        
        /// <summary>
        /// Converts the string representation of a TRAPostalAddressEnvelope to its
        ...
        /// in input, if the conversion succeeded, or default(TRAPostalAddressEnvelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRAPostalAddressEnvelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRAPostalAddressEnvelope>(input);
                return true;
            }
            catch { value = default(TRAPostalAddressEnvelope); return false; }
        }
        public static TRAPostalAddressEnvelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRAPostalAddressEnvelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRAPostalAddressEnvelope defined in TSL.
    /// </summary>
    public unsafe partial class TRAPostalAddressEnvelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRAPostalAddressEnvelope_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new TRAPostalAddressContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        TRAPostalAddressContent_Accessor content_Accessor_Field;
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe TRAPostalAddressContent_Accessor content
        {
            get
            {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        public static unsafe implicit operator TRAPostalAddressEnvelope(TRAPostalAddressEnvelope_Accessor accessor)
        {
            TRAPostalAddressContent? _content = default(TRAPostalAddressContent?);
            if (accessor.Contains_content)
            {
                
                _content = (TRAPostalAddressContent)accessor.content;
                
            }
            
            return new TRAPostalAddressEnvelope(
        ...
        public unsafe static implicit operator TRAPostalAddressEnvelope_Accessor(TRAPostalAddressEnvelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.Value.streetAddress!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.streetAddress.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.postOfficeBoxNumber.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.addressLocality!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.addressLocality.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.addressRegion!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.addressRegion.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.addressCountry!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.addressCountry.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.Value.postalCode!= null)
        {
            int strlen_4 = field.content.Value.claims.Value.postalCode.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.Value.streetAddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.streetAddress)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.postOfficeBoxNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.postOfficeBoxNumber)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.addressLocality!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.addressLocality)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.addressRegion!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.addressRegion)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.addressCountry!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.addressCountry)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.Value.postalCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.Value.postalCode)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
...
*(optheader_2 + 0) |= 0x02;
            ...
            }TRAPostalAddressEnvelope_Accessor ret;
            
            ret = new TRAPostalAddressEnvelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRAPostalAddressEnvelope_Accessor a, TRAPostalAddressEnvelope_Accessor b)
        {
