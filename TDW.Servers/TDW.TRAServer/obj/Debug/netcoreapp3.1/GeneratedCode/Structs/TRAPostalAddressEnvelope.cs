...
namespace TDW.TRAServer
{
    ...
    public partial struct TRAPostalAddressEnvelope
    {
        ...
        ///</summary>
        public TRAPostalAddressEnvelope(TRAPostalAddressContent? content = default(TRAPostalAddressContent?),string encryptedcontent = default(string),TRACredentialMetadata metadata = default(TRACredentialMetadata))
        {
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.streetAddress!= null)
        {
            int strlen_4 = field.content.Value.claims.streetAddress.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.postOfficeBoxNumber!= null)
        {
            int strlen_4 = field.content.Value.claims.postOfficeBoxNumber.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.addressLocality!= null)
        {
            int strlen_4 = field.content.Value.claims.addressLocality.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.addressRegion!= null)
        {
            int strlen_4 = field.content.Value.claims.addressRegion.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.addressCountry!= null)
        {
            int strlen_4 = field.content.Value.claims.addressCountry.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.content.Value.claims.postalCode!= null)
        {
            int strlen_4 = field.content.Value.claims.postalCode.Length * 2;
            targetPtr += strlen_4+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.streetAddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.streetAddress)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.postOfficeBoxNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.postOfficeBoxNumber)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.addressLocality!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.addressLocality)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.addressRegion!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.addressRegion)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.addressCountry!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.addressCountry)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
        ...
        if(field.content.Value.claims.postalCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_4;
            targetPtr += sizeof(int);
            fixed(char* pstr_4 = field.content.Value.claims.postalCode)
            {
                Memory.Copy(pstr_4, targetPtr, strlen_4);
                targetPtr += strlen_4;
            }
