...
namespace TDW.TRAServer
{
    ...
    public partial struct TRAPostalAddressEnvelope
    {
        ...
        ///</summary>
        public TRAPostalAddressEnvelope(TRAPostalAddressContent? content = default(TRAPostalAddressContent?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
