...
namespace TDW.TRAServer
{
    ...
    public partial struct Cac_Address_Content
    {
        ...
        ///</summary>
        public Cac_Address_Content(string udid = default(string),List<string> context = default(List<string>),Cac_Address_Claims? claims = default(Cac_Address_Claims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);{{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}}}
        ...
        {
            Cac_Address_Claims? _claims = default(Cac_Address_Claims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (Cac_Address_Claims)accessor.claims;
...

{
    ...
    if(field.context!= null)
    {
        ...
        if(field.claims.Value.cbc_PostBox!= null)
        {
            int strlen_3 = field.claims.Value.cbc_PostBox.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_StreetName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_StreetName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_AdditionalStreetName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_AdditionalStreetName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_BuildingNumber!= null)
        {
            int strlen_3 = field.claims.Value.cbc_BuildingNumber.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_Department!= null)
        {
            int strlen_3 = field.claims.Value.cbc_Department.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_CityName!= null)
        {
            int strlen_3 = field.claims.Value.cbc_CityName.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_CountrySubentityCode!= null)
        {
            int strlen_3 = field.claims.Value.cbc_CountrySubentityCode.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode._listID!= null)
        {
            int strlen_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode._listID.Length * 2;
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode._listAgencyID!= null)
        {
            int strlen_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode._listAgencyID.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode.code!= null)
        {
            int strlen_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode.code.Length * 2;
            targetPtr += strlen_5+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.cbc_PostBox!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_PostBox)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_StreetName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_StreetName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_AdditionalStreetName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_AdditionalStreetName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_BuildingNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_BuildingNumber)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_Department!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_Department)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_CityName!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_CityName)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_CountrySubentityCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.cbc_CountrySubentityCode)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode._listID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode._listID)
            {
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode._listAgencyID!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode._listAgencyID)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
        ...
        if(field.claims.Value.cbc_Country.cbc_IdentificationCode.code!= null)
        {
            ...
            *(int*)targetPtr = strlen_5;
            targetPtr += sizeof(int);
            fixed(char* pstr_5 = field.claims.Value.cbc_Country.cbc_IdentificationCode.code)
            {
                Memory.Copy(pstr_5, targetPtr, strlen_5);
                targetPtr += strlen_5;
            }
