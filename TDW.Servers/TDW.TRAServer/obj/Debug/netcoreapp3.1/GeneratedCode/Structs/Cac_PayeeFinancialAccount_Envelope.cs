...
namespace TDW.TRAServer
{
    ...
    public partial struct Cac_PayeeFinancialAccount_Envelope
    {
        ...
        ///</summary>
        public Cac_PayeeFinancialAccount_Envelope(Cac_PayeeFinancialAccount_EnvelopeContent content = default(Cac_PayeeFinancialAccount_EnvelopeContent),TRACredential_EnvelopeLabel label = default(TRACredential_EnvelopeLabel))
        {
        ...
        public Cac_PayeeFinancialAccount_EnvelopeContent content;
    ...
    public unsafe partial class Cac_PayeeFinancialAccount_Envelope_Accessor : IAccessor
    {
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_PayeeFinancialAccount_EnvelopeContent_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_PayeeFinancialAccount_EnvelopeContent_Accessor content_Accessor_Field;
        
        ///<summary>
        ///Provides in-place access to the object field content.
        ///</summary>
        public unsafe Cac_PayeeFinancialAccount_EnvelopeContent_Accessor content
        {
            get
            {
...

{
    ...
    if(field.content.context!= null)
    {
        ...
        if(field.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            int strlen_6 = field.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID.Length * 2;
...
*(optheader_2 + 0) |= 0x01;
        ...
        if(field.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.claims.Value.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID)
            {
