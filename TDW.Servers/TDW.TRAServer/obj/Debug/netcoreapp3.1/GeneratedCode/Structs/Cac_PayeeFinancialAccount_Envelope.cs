...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of Cac_PayeeFinancialAccount_Envelope defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct Cac_PayeeFinancialAccount_Envelope
    {
        
        ///<summary>
        ///Initializes a new instance of Cac_PayeeFinancialAccount_Envelope with the specified parameters.
        ///</summary>
        public Cac_PayeeFinancialAccount_Envelope(Cac_PayeeFinancialAccount_Content? content = default(Cac_PayeeFinancialAccount_Content?),string encryptedcontent = default(string),TRACredential_Label label = default(TRACredential_Label))
        {
        ...
        public static bool operator ==(Cac_PayeeFinancialAccount_Envelope a, Cac_PayeeFinancialAccount_Envelope b)
        {
        ...
        public Cac_PayeeFinancialAccount_Content? content;
        ...
        /// <summary>
        /// Converts the string representation of a Cac_PayeeFinancialAccount_Envelope to its
        ...
        /// in input, if the conversion succeeded, or default(Cac_PayeeFinancialAccount_Envelope) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out Cac_PayeeFinancialAccount_Envelope value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PayeeFinancialAccount_Envelope>(input);
                return true;
            }
            catch { value = default(Cac_PayeeFinancialAccount_Envelope); return false; }
        }
        public static Cac_PayeeFinancialAccount_Envelope Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Cac_PayeeFinancialAccount_Envelope>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of Cac_PayeeFinancialAccount_Envelope defined in TSL.
    /// </summary>
    public unsafe partial class Cac_PayeeFinancialAccount_Envelope_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe Cac_PayeeFinancialAccount_Envelope_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                    content_Accessor_Field = new Cac_PayeeFinancialAccount_Content_Accessor(null,
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        #endregion
        Cac_PayeeFinancialAccount_Content_Accessor content_Accessor_Field;
        ...
        ///</summary>
        public unsafe Cac_PayeeFinancialAccount_Content_Accessor content
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator Cac_PayeeFinancialAccount_Envelope(Cac_PayeeFinancialAccount_Envelope_Accessor accessor)
        {
            Cac_PayeeFinancialAccount_Content? _content = default(Cac_PayeeFinancialAccount_Content?);
            if (accessor.Contains_content)
            {
                
                _content = (Cac_PayeeFinancialAccount_Content)accessor.content;
            ...
            return new Cac_PayeeFinancialAccount_Envelope(
        ...
        public unsafe static implicit operator Cac_PayeeFinancialAccount_Envelope_Accessor(Cac_PayeeFinancialAccount_Envelope field)
        {
            byte* targetPtr = null;
...

{
    ...
    if(field.content.Value.context!= null)
    {
        ...
        if(field.content.Value.claims.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            int strlen_6 = field.content.Value.claims.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID.Length * 2;
...
*(int*)storedPtr_3 = (int)(targetPtr - storedPtr_3 - 4);
        ...
        if(field.content.Value.claims.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID!= null)
        {
            ...
            *(int*)targetPtr = strlen_6;
            targetPtr += sizeof(int);
            fixed(char* pstr_6 = field.content.Value.claims.cac_FinancialInstitutionBranch.cac_FinancialInstitution.cbc_ID)
            {
...
*(optheader_2 + 0) |= 0x02;
            ...
            }Cac_PayeeFinancialAccount_Envelope_Accessor ret;
            
            ret = new Cac_PayeeFinancialAccount_Envelope_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(Cac_PayeeFinancialAccount_Envelope_Accessor a, Cac_PayeeFinancialAccount_Envelope_Accessor b)
        {
