...
namespace TDW.TRAServer
{
    ...
    public partial struct TRAPostalAddressContent
    {
        ...
        ///</summary>
        public TRAPostalAddressContent(string udid = default(string),List<string> context = default(List<string>),TRAPostalAddressClaims? claims = default(TRAPostalAddressClaims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
...
{targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        {
            TRAPostalAddressClaims? _claims = default(TRAPostalAddressClaims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (TRAPostalAddressClaims)accessor.claims;
...

{
    ...
    if(field.context!= null)
    {
        ...
        if(field.claims.Value.streetAddress!= null)
        {
            int strlen_3 = field.claims.Value.streetAddress.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.postOfficeBoxNumber!= null)
        {
            int strlen_3 = field.claims.Value.postOfficeBoxNumber.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.addressLocality!= null)
        {
            int strlen_3 = field.claims.Value.addressLocality.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.addressRegion!= null)
        {
            int strlen_3 = field.claims.Value.addressRegion.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.addressCountry!= null)
        {
            int strlen_3 = field.claims.Value.addressCountry.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
        ...
        if(field.claims.Value.postalCode!= null)
        {
            int strlen_3 = field.claims.Value.postalCode.Length * 2;
            targetPtr += strlen_3+sizeof(int);
        }else
        {
            targetPtr += sizeof(int);
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
        ...
        if(field.claims.Value.streetAddress!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.streetAddress)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.postOfficeBoxNumber!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.postOfficeBoxNumber)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.addressLocality!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.addressLocality)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.addressRegion!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.addressRegion)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.addressCountry!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.addressCountry)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
        ...
        if(field.claims.Value.postalCode!= null)
        {
            ...
            *(int*)targetPtr = strlen_3;
            targetPtr += sizeof(int);
            fixed(char* pstr_3 = field.claims.Value.postalCode)
            {
                Memory.Copy(pstr_3, targetPtr, strlen_3);
                targetPtr += strlen_3;
            }
