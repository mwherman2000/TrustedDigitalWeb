...
namespace TDW.TRAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of TRAGeoLocationContent defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct TRAGeoLocationContent
    {
        
        ///<summary>
        ///Initializes a new instance of TRAGeoLocationContent with the specified parameters.
        ///</summary>
        public TRAGeoLocationContent(string udid = default(string),List<string> context = default(List<string>),TRAGeoLocationClaims? claims = default(TRAGeoLocationClaims?),TRAEncryptedClaims? encryptedclaims = default(TRAEncryptedClaims?))
        {
        ...
        public static bool operator ==(TRAGeoLocationContent a, TRAGeoLocationContent b)
        {
        ...
        public TRAGeoLocationClaims? claims;
        
        public TRAEncryptedClaims? encryptedclaims;
        
        /// <summary>
        /// Converts the string representation of a TRAGeoLocationContent to its
        ...
        /// in input, if the conversion succeeded, or default(TRAGeoLocationContent) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out TRAGeoLocationContent value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<TRAGeoLocationContent>(input);
                return true;
            }
            catch { value = default(TRAGeoLocationContent); return false; }
        }
        public static TRAGeoLocationContent Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TRAGeoLocationContent>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of TRAGeoLocationContent defined in TSL.
    /// </summary>
    public unsafe partial class TRAGeoLocationContent_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe TRAGeoLocationContent_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        claims_Accessor_Field = new TRAGeoLocationClaims_Accessor(null);        encryptedclaims_Accessor_Field = new TRAEncryptedClaims_Accessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        TRAGeoLocationClaims_Accessor claims_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        ///</summary>
        public unsafe TRAGeoLocationClaims_Accessor claims
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator TRAGeoLocationContent(TRAGeoLocationContent_Accessor accessor)
        {
            TRAGeoLocationClaims? _claims = default(TRAGeoLocationClaims?);
            if (accessor.Contains_claims)
            {
                
                _claims = (TRAGeoLocationClaims)accessor.claims;
            ...
            return new TRAGeoLocationContent(
        ...
        public unsafe static implicit operator TRAGeoLocationContent_Accessor(TRAGeoLocationContent field)
        {
            byte* targetPtr = null;
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
            ...
            {
            *(double*)targetPtr = field.claims.Value.latitude;
            targetPtr += 8;
            *(double*)targetPtr = field.claims.Value.longitude;
            targetPtr += 8;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }TRAGeoLocationContent_Accessor ret;
            
            ret = new TRAGeoLocationContent_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(TRAGeoLocationContent_Accessor a, TRAGeoLocationContent_Accessor b)
        {
