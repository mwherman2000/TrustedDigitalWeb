...
namespace TDW.TRAServer
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="TDW.TRAServer.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through TDW.TRAServer.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
