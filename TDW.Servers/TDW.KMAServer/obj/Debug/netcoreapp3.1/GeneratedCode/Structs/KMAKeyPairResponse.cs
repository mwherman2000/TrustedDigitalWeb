...
namespace TDW.KMAServer
{
    ...
    /// <summary>
    /// A .NET runtime object representation of KMAKeyPairResponse defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct KMAKeyPairResponse
    {
        
        ///<summary>
        ///Initializes a new instance of KMAKeyPairResponse with the specified parameters.
        ///</summary>
        public KMAKeyPairResponse(long id = default(long),string udid = default(string),long rc = default(long),List<string> messages = default(List<string>))
        {
        ...
        public static bool operator ==(KMAKeyPairResponse a, KMAKeyPairResponse b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a KMAKeyPairResponse to its
        ...
        /// in input, if the conversion succeeded, or default(KMAKeyPairResponse) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out KMAKeyPairResponse value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<KMAKeyPairResponse>(input);
                return true;
            }
            catch { value = default(KMAKeyPairResponse); return false; }
        }
        public static KMAKeyPairResponse Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<KMAKeyPairResponse>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of KMAKeyPairResponse defined in TSL.
    /// </summary>
    public unsafe partial class KMAKeyPairResponse_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe KMAKeyPairResponse_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);            targetPtr += 8;
        ...
        public static unsafe implicit operator KMAKeyPairResponse(KMAKeyPairResponse_Accessor accessor)
        {
            
            return new KMAKeyPairResponse(
        ...
        public unsafe static implicit operator KMAKeyPairResponse_Accessor(KMAKeyPairResponse field)
        {
            byte* targetPtr = null;
...
*(int*)storedPtr_2 = (int)(targetPtr - storedPtr_2 - 4);
            ...
            }KMAKeyPairResponse_Accessor ret;
            
            ret = new KMAKeyPairResponse_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(KMAKeyPairResponse_Accessor a, KMAKeyPairResponse_Accessor b)
        {
