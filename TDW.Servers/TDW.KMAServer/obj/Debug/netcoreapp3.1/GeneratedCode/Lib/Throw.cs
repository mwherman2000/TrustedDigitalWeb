...
namespace TDW.KMAServer
{
    class Throw
    {
        ...
        internal static void parse_KMAKeyPairType(string value)
        {
            throw new ArgumentException("Cannot parse \""+value+"\" into KMAKeyPairType.");
        }
        internal static void incompatible_with_KMAKeyPairType()
        {
            throw new DataTypeIncompatibleException("Data type 'KMAKeyPairType' not compatible with the target field.");
        }
