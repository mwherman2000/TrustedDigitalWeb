...
namespace TDW.KMAServer
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="TDW.KMAServer.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through TDW.KMAServer.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
